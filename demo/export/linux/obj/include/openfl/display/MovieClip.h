...
class HXCPP_CLASS_ATTRIBUTES MovieClip_obj : public  ::openfl::display::Sprite_obj
{
	...
	public:
		...
		static void __boot();
		static  ::openfl::_internal::formats::swf::SWFLite _hx___initSWF;
		...
		bool _hx___playing;
		 ::openfl::_internal::formats::swf::SWFLite _hx___swf;
		...
		void _hx___fromSymbol( ::openfl::_internal::formats::swf::SWFLite swf, ::openfl::_internal::symbols::SpriteSymbol symbol);
		...
		void _hx___updateDisplayObject( ::openfl::display::DisplayObject displayObject, ::openfl::_internal::symbols::timeline::FrameObject frameObject,hx::Null< bool >  reset);
