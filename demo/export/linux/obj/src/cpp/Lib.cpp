...
HX_LOCAL_STACK_FRAME(_hx_pos_1516ef77903f4295_38_load,"cpp.Lib","load",0xd2b2dcba,"cpp.Lib.load","/home/oddone9139/.opam/default/share/haxe/std/cpp/Lib.hx",38,0x956581ef)
HX_LOCAL_STACK_FRAME(_hx_pos_1516ef77903f4295_69_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/home/oddone9139/.opam/default/share/haxe/std/cpp/Lib.hx",69,0x956581ef)
HX_LOCAL_STACK_FRAME(_hx_pos_1516ef77903f4295_73_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/home/oddone9139/.opam/default/share/haxe/std/cpp/Lib.hx",73,0x956581ef)
HX_LOCAL_STACK_FRAME(_hx_pos_1516ef77903f4295_74_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/home/oddone9139/.opam/default/share/haxe/std/cpp/Lib.hx",74,0x956581ef)
HX_LOCAL_STACK_FRAME(_hx_pos_1516ef77903f4295_75_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/home/oddone9139/.opam/default/share/haxe/std/cpp/Lib.hx",75,0x956581ef)
HX_LOCAL_STACK_FRAME(_hx_pos_1516ef77903f4295_76_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/home/oddone9139/.opam/default/share/haxe/std/cpp/Lib.hx",76,0x956581ef)
HX_LOCAL_STACK_FRAME(_hx_pos_1516ef77903f4295_77_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/home/oddone9139/.opam/default/share/haxe/std/cpp/Lib.hx",77,0x956581ef)
HX_LOCAL_STACK_FRAME(_hx_pos_1516ef77903f4295_78_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/home/oddone9139/.opam/default/share/haxe/std/cpp/Lib.hx",78,0x956581ef)
namespace cpp{
...
bool Lib_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Lib_obj::load(::String lib,::String prim,int nargs){
            	HX_STACKFRAME(&_hx_pos_1516ef77903f4295_38_load)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Lib_obj,load,return )
 ...
 ::Dynamic Lib_obj::loadLazy(::String lib,::String prim,int nargs){
            	HX_STACKFRAME(&_hx_pos_1516ef77903f4295_69_loadLazy)
HXDLIN(  69)		try {
...
HXLINE(  72)				switch((int)(nargs)){
            					case (int)0: {
            						...
            						void _hx_run(){
            							HX_STACKFRAME(&_hx_pos_1516ef77903f4295_73_loadLazy)
...
HXLINE(  73)						return  ::Dynamic(new _hx_Closure_1(e));
            					...
            					case (int)2: {
            						...
            						void _hx_run( ::Dynamic _1, ::Dynamic _2){
            							HX_STACKFRAME(&_hx_pos_1516ef77903f4295_74_loadLazy)
...
HXLINE(  74)						return  ::Dynamic(new _hx_Closure_2(e));
            					...
            					case (int)3: {
            						...
            						void _hx_run( ::Dynamic _11, ::Dynamic _21, ::Dynamic _3){
            							HX_STACKFRAME(&_hx_pos_1516ef77903f4295_75_loadLazy)
...
HXLINE(  75)						return  ::Dynamic(new _hx_Closure_3(e));
            					...
            					case (int)4: {
            						...
            						void _hx_run( ::Dynamic _12, ::Dynamic _22, ::Dynamic _31, ::Dynamic _4){
            							HX_STACKFRAME(&_hx_pos_1516ef77903f4295_76_loadLazy)
...
HXLINE(  76)						return  ::Dynamic(new _hx_Closure_4(e));
            					...
            					case (int)5: {
            						...
            						void _hx_run( ::Dynamic _13, ::Dynamic _23, ::Dynamic _32, ::Dynamic _41, ::Dynamic _5){
            							HX_STACKFRAME(&_hx_pos_1516ef77903f4295_77_loadLazy)
...
HXLINE(  77)						return  ::Dynamic(new _hx_Closure_5(e));
            					...
            					default:{
            						...
            						void _hx_run( ::Dynamic _14){
            							HX_STACKFRAME(&_hx_pos_1516ef77903f4295_78_loadLazy)
