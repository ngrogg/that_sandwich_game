...
HX_LOCAL_STACK_FRAME(_hx_pos_f2873c031a8a146e_67_fromLimeEndian,"openfl.utils._Endian.Endian_Impl_","fromLimeEndian",0x810f0bde,"openfl.utils._Endian.Endian_Impl_.fromLimeEndian","openfl/utils/Endian.hx",67,0xb1ee6086)
HX_LOCAL_STACK_FRAME(_hx_pos_f2873c031a8a146e_81_fromString,"openfl.utils._Endian.Endian_Impl_","fromString",0x910e541f,"openfl.utils._Endian.Endian_Impl_.fromString","openfl/utils/Endian.hx",81,0xb1ee6086)
HX_LOCAL_STACK_FRAME(_hx_pos_f2873c031a8a146e_95_toLimeEndian,"openfl.utils._Endian.Endian_Impl_","toLimeEndian",0x6c00922f,"openfl.utils._Endian.Endian_Impl_.toLimeEndian","openfl/utils/Endian.hx",95,0xb1ee6086)
HX_LOCAL_STACK_FRAME(_hx_pos_f2873c031a8a146e_109_toString,"openfl.utils._Endian.Endian_Impl_","toString",0x9a281df0,"openfl.utils._Endian.Endian_Impl_.toString","openfl/utils/Endian.hx",109,0xb1ee6086)
...
bool Endian_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Endian_Impl__obj::fromLimeEndian( ::lime::_hx_system::Endian value){
            	HX_STACKFRAME(&_hx_pos_f2873c031a8a146e_67_fromLimeEndian)
HXDLIN(  67)		switch((int)(_hx_getEnumValueIndex(value))){
            			case (int)0: {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Endian_Impl__obj,fromLimeEndian,return )
 ...
 ::Dynamic Endian_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_f2873c031a8a146e_81_fromString)
HXDLIN(  81)		::String _hx_switch_0 = value;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Endian_Impl__obj,fromString,return )
 ...
 ::lime::_hx_system::Endian Endian_Impl__obj::toLimeEndian(int value){
            	HX_STACKFRAME(&_hx_pos_f2873c031a8a146e_95_toLimeEndian)
HXDLIN(  95)		switch((int)(value)){
            			case (int)0: {
HXLINE(  97)				return ::lime::_hx_system::Endian_obj::_hx_BIG_ENDIAN_dyn();
            			}
            			break;
            			case (int)1: {
HXLINE(  98)				return ::lime::_hx_system::Endian_obj::_hx_LITTLE_ENDIAN_dyn();
            			}
            			break;
            			default:{
...
::String Endian_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_f2873c031a8a146e_109_toString)
HXDLIN( 109)		switch((int)(value)){
            			case (int)0: {
HXLINE( 111)				return HX_("bigEndian",7b,d5,5a,20);
            			}
            			break;
            			case (int)1: {
HXLINE( 112)				return HX_("littleEndian",31,2e,7b,07);
            			}
            			break;
            			default:{
...
HXDLIN(  42)		_hx_BIG_ENDIAN = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_f2873c031a8a146e_61_boot)
HXDLIN(  61)		_hx_LITTLE_ENDIAN = (int)1;
            	}
}
