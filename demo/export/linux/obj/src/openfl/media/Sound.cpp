...
HXLINE( 405)		int a = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(bytes);
HXDLIN( 405)		bool aNeg = (a < (int)0);
HXDLIN( 405)		bool bNeg = (bytesLength < (int)0);
HXDLIN( 405)		bool _hx_tmp1;
HXDLIN( 405)		if ((aNeg != bNeg)) {
HXLINE( 405)			_hx_tmp1 = aNeg;
            		}
            		else {
HXLINE( 405)			_hx_tmp1 = (a > bytesLength);
            		}
