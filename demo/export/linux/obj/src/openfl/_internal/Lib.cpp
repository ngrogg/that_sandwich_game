...
HX_LOCAL_STACK_FRAME(_hx_pos_7288ada1c7eddece_27_notImplemented,"openfl._internal.Lib","notImplemented",0xa949dbc8,"openfl._internal.Lib.notImplemented","openfl/_internal/Lib.hx",27,0xe5ec63ab)
HX_LOCAL_STACK_FRAME(_hx_pos_7288ada1c7eddece_24_boot,"openfl._internal.Lib","boot",0xa890ac4b,"openfl._internal.Lib.boot","openfl/_internal/Lib.hx",24,0xe5ec63ab)
namespace openfl{
namespace _internal{
...
void Lib_obj::notImplemented( ::Dynamic posInfo){
            	HX_STACKFRAME(&_hx_pos_7288ada1c7eddece_27_notImplemented)
HXLINE(  29)		::String api = ((( (::String)(posInfo->__Field(HX_("className",a3,92,3d,dc),hx::paccDynamic)) ) + HX_(".",2e,00,00,00)) + ( (::String)(posInfo->__Field(HX_("methodName",cc,19,0f,12),hx::paccDynamic)) ));
HXLINE(  31)		if (!(::openfl::_internal::Lib_obj::_hx___sentWarnings->exists(api))) {
HXLINE(  33)			::openfl::_internal::Lib_obj::_hx___sentWarnings->set(api,true);
HXLINE(  35)			::lime::utils::Log_obj::warn((( (::String)(posInfo->__Field(HX_("methodName",cc,19,0f,12),hx::paccDynamic)) ) + HX_(" is not implemented",1f,12,d2,b9)),posInfo);
            		}
            	}
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_7288ada1c7eddece_24_boot)
HXDLIN(  24)		_hx___sentWarnings =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
}
