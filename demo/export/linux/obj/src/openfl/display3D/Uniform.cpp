...
HX_DEFINE_STACK_FRAME(_hx_pos_2880df2f01d21cf0_793_new,"openfl.display3D.Uniform","new",0x27a38f2d,"openfl.display3D.Uniform.new","openfl/display3D/Program3D.hx",793,0x0a985b04)
HX_LOCAL_STACK_FRAME(_hx_pos_2880df2f01d21cf0_806_flush,"openfl.display3D.Uniform","flush",0x6c722ed1,"openfl.display3D.Uniform.flush","openfl/display3D/Program3D.hx",806,0x0a985b04)
HX_LOCAL_STACK_FRAME(_hx_pos_2880df2f01d21cf0_849___getUniformRegisters,"openfl.display3D.Uniform","__getUniformRegisters",0xe23bc87f,"openfl.display3D.Uniform.__getUniformRegisters","openfl/display3D/Program3D.hx",849,0x0a985b04)
namespace openfl{
namespace display3D{

void Uniform_obj::__construct( ::openfl::display3D::Context3D context){
            	HX_GC_STACKFRAME(&_hx_pos_2880df2f01d21cf0_793_new)
HXLINE( 795)		this->context = context;
HXLINE( 797)		this->isDirty = true;
HXLINE( 800)		 ::lime::utils::BytePointerData this1 =  ::lime::utils::BytePointerData_obj::__alloc( HX_CTX ,null(),(int)0);
HXDLIN( 800)		this->regDataPointer = this1;
            	}
...
void Uniform_obj::flush(){
            	HX_STACKFRAME(&_hx_pos_2880df2f01d21cf0_806_flush)
HXLINE( 812)		 ::lime::_internal::backend::native::NativeOpenGLRenderContext gl = this->context->_hx___context->gles2;
HXLINE( 815)		int index = (this->regIndex * (int)4);
HXLINE( 816)		{
HXLINE( 816)			int _g = this->type;
HXDLIN( 816)			switch((int)(_g)){
            				case (int)35664: {
HXLINE( 830)					int location = this->location;
HXDLIN( 830)					int count = this->regCount;
HXDLIN( 830)					int size = (this->regCount * (int)2);
HXDLIN( 830)					 ::lime::utils::BytePointerData v = this->regDataPointer;
HXDLIN( 830)					 ::lime::utils::ArrayBufferView v1 = this->regData;
HXDLIN( 830)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(v,null(),v1,null(),(index * (int)4));
HXDLIN( 830)					gl->uniform2fv(location,count,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer));
            				}
            				break;
            				case (int)35665: {
HXLINE( 831)					int location1 = this->location;
HXDLIN( 831)					int count1 = this->regCount;
HXDLIN( 831)					int size1 = (this->regCount * (int)3);
HXDLIN( 831)					 ::lime::utils::BytePointerData v2 = this->regDataPointer;
HXDLIN( 831)					 ::lime::utils::ArrayBufferView v3 = this->regData;
HXDLIN( 831)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(v2,null(),v3,null(),(index * (int)4));
HXDLIN( 831)					gl->uniform3fv(location1,count1,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer));
            				}
            				break;
            				case (int)35666: {
HXLINE( 832)					int location2 = this->location;
HXDLIN( 832)					int count2 = this->regCount;
HXDLIN( 832)					int size2 = (this->regCount * (int)4);
HXDLIN( 832)					 ::lime::utils::BytePointerData v4 = this->regDataPointer;
HXDLIN( 832)					 ::lime::utils::ArrayBufferView v5 = this->regData;
HXDLIN( 832)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(v4,null(),v5,null(),(index * (int)4));
HXDLIN( 832)					gl->uniform4fv(location2,count2,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer));
            				}
            				break;
            				case (int)35674: {
HXLINE( 827)					int location3 = this->location;
HXDLIN( 827)					int count3 = this->size;
HXDLIN( 827)					int size3 = ((this->size * (int)2) * (int)2);
HXDLIN( 827)					 ::lime::utils::BytePointerData v6 = this->regDataPointer;
HXDLIN( 827)					 ::lime::utils::ArrayBufferView v7 = this->regData;
HXDLIN( 827)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(v6,null(),v7,null(),(index * (int)4));
HXDLIN( 827)					gl->uniformMatrix2fv(location3,count3,false,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer));
            				}
            				break;
            				case (int)35675: {
HXLINE( 828)					int location4 = this->location;
HXDLIN( 828)					int count4 = this->size;
HXDLIN( 828)					int size4 = ((this->size * (int)3) * (int)3);
HXDLIN( 828)					 ::lime::utils::BytePointerData v8 = this->regDataPointer;
HXDLIN( 828)					 ::lime::utils::ArrayBufferView v9 = this->regData;
HXDLIN( 828)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(v8,null(),v9,null(),(index * (int)4));
HXDLIN( 828)					gl->uniformMatrix3fv(location4,count4,false,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer));
            				}
            				break;
            				case (int)35676: {
HXLINE( 829)					int location5 = this->location;
HXDLIN( 829)					int count5 = this->size;
HXDLIN( 829)					int size5 = ((this->size * (int)4) * (int)4);
HXDLIN( 829)					 ::lime::utils::BytePointerData v10 = this->regDataPointer;
HXDLIN( 829)					 ::lime::utils::ArrayBufferView v11 = this->regData;
HXDLIN( 829)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(v10,null(),v11,null(),(index * (int)4));
HXDLIN( 829)					gl->uniformMatrix4fv(location5,count5,false,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer));
            				}
            				break;
            				default:{
HXLINE( 833)					int location6 = this->location;
HXDLIN( 833)					int count6 = this->regCount;
HXDLIN( 833)					int size6 = (this->regCount * (int)4);
HXDLIN( 833)					 ::lime::utils::BytePointerData v12 = this->regDataPointer;
HXDLIN( 833)					 ::lime::utils::ArrayBufferView v13 = this->regData;
HXDLIN( 833)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(v12,null(),v13,null(),(index * (int)4));
HXDLIN( 833)					gl->uniform4fv(location6,count6,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer));
            				}
            			}
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Uniform_obj,flush,(void))
 ...
 ::lime::utils::BytePointerData Uniform_obj::_hx___getUniformRegisters(int index,int size){
            	HX_STACKFRAME(&_hx_pos_2880df2f01d21cf0_849___getUniformRegisters)
HXLINE( 851)		 ::lime::utils::BytePointerData _hx_tmp = this->regDataPointer;
HXDLIN( 851)		 ::lime::utils::ArrayBufferView _hx_tmp1 = this->regData;
HXDLIN( 851)		::lime::utils::_BytePointer::BytePointer_Impl__obj::set(_hx_tmp,null(),_hx_tmp1,null(),(index * (int)4));
HXLINE( 852)		return this->regDataPointer;
            	}
