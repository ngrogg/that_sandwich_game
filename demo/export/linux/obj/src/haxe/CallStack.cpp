...
HX_LOCAL_STACK_FRAME(_hx_pos_f42d4c79b4146fa8_231_toString,"haxe.CallStack","toString",0xd59be738,"haxe.CallStack.toString","/home/oddone9139/.opam/default/share/haxe/std/haxe/CallStack.hx",231,0xd58008d3)
static const ::String _hx_array_data_6d544b62_2[] = {
	HX_("\nCalled from ",bd,26,6b,81),
};
HX_LOCAL_STACK_FRAME(_hx_pos_f42d4c79b4146fa8_241_itemToString,"haxe.CallStack","itemToString",0xc121696b,"haxe.CallStack.itemToString","/home/oddone9139/.opam/default/share/haxe/std/haxe/CallStack.hx",241,0xd58008d3)
...
::String CallStack_obj::toString(::Array< ::Dynamic> stack){
            	HX_GC_STACKFRAME(&_hx_pos_f42d4c79b4146fa8_231_toString)
...
HXLINE( 234)						b->b = ::Array_obj< ::String >::fromData( _hx_array_data_6d544b62_2,1);
            					}
            					else {
...
void CallStack_obj::itemToString( ::StringBuf b, ::haxe::StackItem s){
            	HX_STACKFRAME(&_hx_pos_f42d4c79b4146fa8_241_itemToString)
...
HXLINE( 243)					b->b = ::Array_obj< ::String >::fromData( _hx_array_data_6d544b62_4,1);
            				}
            				else {
...
HXLINE( 245)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_6d544b62_5,1);
            						}
            						else {
...
HXLINE( 250)								b->b = ::Array_obj< ::String >::fromData( _hx_array_data_6d544b62_6,1);
            							}
            							else {
...
HXLINE( 253)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_6d544b62_7,1);
            						}
            						else {
...
HXLINE( 255)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_6d544b62_8,1);
            						}
            						else {
...
HXLINE( 258)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_6d544b62_9,1);
            						}
            						else {
...
HXLINE( 261)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_6d544b62_10,1);
            						}
            						else {
