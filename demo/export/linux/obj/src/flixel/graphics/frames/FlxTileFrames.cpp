...
HXLINE( 505)			Float Width = this->parent->width;
HXDLIN( 505)			Float Height = this->parent->height;
HXDLIN( 505)			 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 505)			_this->x = (int)0;
HXDLIN( 505)			_this->y = (int)0;
...
HXLINE( 508)			 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 511)			 ::flixel::math::FlxPoint point2 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 520)		 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 520)		point->_inPool = false;
HXDLIN( 520)		 ::flixel::math::FlxPoint resultBorder = point->addPoint(this->border)->addPoint(border);
HXLINE( 521)		 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXDLIN( 521)		Float Y = ((int)2 * border->y);
HXDLIN( 521)		{
HXLINE( 521)			 ::flixel::math::FlxPoint _g = _this1;
HXDLIN( 521)			_g->set_x((_g->x - ((int)2 * border->x)));
            		}
HXDLIN( 521)		{
...
HXDLIN( 530)		_this2->x = (int)0;
HXDLIN( 530)		_this2->y = (int)0;
HXDLIN( 530)		_this2->width = (int)0;
HXDLIN( 530)		_this2->height = (int)0;
...
HXLINE( 533)		 ::flixel::math::FlxPoint point3 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 389)		int totalArea = (int)0;
HXLINE( 390)		int rows = (int)0;
HXLINE( 391)		int cols = (int)0;
HXLINE( 393)		int tileWidth = ::Std_obj::_hx_int(tileframes->__get((int)0).StaticCast<  ::flixel::graphics::frames::FlxTileFrames >()->frames->__get((int)0).StaticCast<  ::flixel::graphics::frames::FlxFrame >()->sourceSize->x);
HXLINE( 394)		int tileHeight = ::Std_obj::_hx_int(tileframes->__get((int)0).StaticCast<  ::flixel::graphics::frames::FlxTileFrames >()->frames->__get((int)0).StaticCast<  ::flixel::graphics::frames::FlxFrame >()->sourceSize->y);
HXLINE( 396)		int spaceX = (int)0;
HXLINE( 397)		int spaceY = (int)0;
HXLINE( 399)		if (hx::IsNotNull( spacing )) {
HXLINE( 401)			spaceX = ::Std_obj::_hx_int(spacing->x);
HXLINE( 402)			spaceY = ::Std_obj::_hx_int(spacing->y);
            		}
HXLINE( 405)		int borderX = (int)0;
HXLINE( 406)		int borderY = (int)0;
...
HXLINE( 418)				totalArea = (totalArea + ::Std_obj::_hx_int((((cols * (tileWidth + ((int)2 * borderX))) * rows) * (tileHeight + ((int)2 * borderY)))));
            			}
            		}
HXLINE( 421)		Float side = ::Math_obj::sqrt(totalArea);
HXLINE( 422)		cols = ::Std_obj::_hx_int(((Float)side / (Float)(tileWidth + ((int)2 * borderX))));
HXLINE( 423)		rows = ::Math_obj::ceil(((Float)totalArea / (Float)((cols * (tileWidth + ((int)2 * borderX))) * (tileHeight + ((int)2 * borderY)))));
HXLINE( 424)		int width = ::Std_obj::_hx_int((cols * (tileWidth + ((int)2 * borderX))));
HXDLIN( 424)		int width1 = (width + ((cols - (int)1) * spaceX));
HXLINE( 425)		int height = ::Std_obj::_hx_int((rows * (tileHeight + ((int)2 * borderY))));
HXDLIN( 425)		int height1 = (height + ((rows - (int)1) * spaceY));
HXLINE( 428)		 ::openfl::display::BitmapData combined =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,width1,height1,true,(int)0);
...
HXDLIN( 433)		_this->x = (int)0;
HXDLIN( 433)		_this->y = (int)0;
HXDLIN( 433)		_this->width = width1;
HXDLIN( 433)		_this->height = height1;
...
HXDLIN( 446)						_this1->width = tileWidth;
HXDLIN( 446)						_this1->height = tileHeight;
HXDLIN( 446)						 ::flixel::math::FlxRect rect1 = _this1;
HXDLIN( 446)						rect1->_inPool = false;
HXDLIN( 446)						 ::flixel::math::FlxRect _hx_tmp = rect1;
...
HXDLIN( 447)						 ::flixel::math::FlxPoint _hx_tmp1 = point2;
HXDLIN( 447)						 ::flixel::math::FlxPoint point3 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 447)						point3->_inPool = false;
HXLINE( 446)						result->addAtlasFrame(_hx_tmp,_hx_tmp1,point3,null(),null(),null(),null());
HXLINE( 448)						 ::openfl::geom::Point destPoint1 = destPoint;
HXDLIN( 448)						destPoint1->x = (destPoint1->x + ((tileWidth + ((int)2 * borderX)) + spaceX));
HXLINE( 450)						if ((destPoint->x >= combined->width)) {
HXLINE( 452)							destPoint->x = borderX;
HXLINE( 453)							 ::openfl::geom::Point destPoint2 = destPoint;
HXDLIN( 453)							destPoint2->y = (destPoint2->y + ((tileHeight + ((int)2 * borderY)) + spaceY));
            						}
            					}
            				}
            			}
...
HXDLIN( 478)		::cpp::VirtualArray collections = ( (::cpp::VirtualArray)(::haxe::IMap_obj::get(graphic->frameCollections,type)) );
HXDLIN( 478)		if (hx::IsNull( collections )) {
HXLINE( 478)			collections = ::Array_obj< ::Dynamic>::__new();
HXDLIN( 478)			::haxe::IMap_obj::set(graphic->frameCollections,type,collections);
            		}
HXDLIN( 478)		::Array< ::Dynamic> tileFrames = collections;
HXLINE( 480)		{
HXLINE( 480)			int _g = (int)0;
