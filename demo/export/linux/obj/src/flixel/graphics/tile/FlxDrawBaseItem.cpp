...
HX_LOCAL_STACK_FRAME(_hx_pos_0484b113da1bcafb_84_reset,"flixel.graphics.tile.FlxDrawBaseItem","reset",0x6670342c,"flixel.graphics.tile.FlxDrawBaseItem.reset","flixel/graphics/tile/FlxDrawBaseItem.hx",84,0xe6349cf4)
HX_LOCAL_STACK_FRAME(_hx_pos_0484b113da1bcafb_92_dispose,"flixel.graphics.tile.FlxDrawBaseItem","dispose",0x64897c3c,"flixel.graphics.tile.FlxDrawBaseItem.dispose","flixel/graphics/tile/FlxDrawBaseItem.hx",92,0xe6349cf4)
HX_LOCAL_STACK_FRAME(_hx_pos_0484b113da1bcafb_101_render,"flixel.graphics.tile.FlxDrawBaseItem","render",0x386e9259,"flixel.graphics.tile.FlxDrawBaseItem.render","flixel/graphics/tile/FlxDrawBaseItem.hx",101,0xe6349cf4)
HX_LOCAL_STACK_FRAME(_hx_pos_0484b113da1bcafb_104_addQuad,"flixel.graphics.tile.FlxDrawBaseItem","addQuad",0x30847725,"flixel.graphics.tile.FlxDrawBaseItem.addQuad","flixel/graphics/tile/FlxDrawBaseItem.hx",104,0xe6349cf4)
HX_LOCAL_STACK_FRAME(_hx_pos_0484b113da1bcafb_108_get_numVertices,"flixel.graphics.tile.FlxDrawBaseItem","get_numVertices",0x6c4b2893,"flixel.graphics.tile.FlxDrawBaseItem.get_numVertices","flixel/graphics/tile/FlxDrawBaseItem.hx",108,0xe6349cf4)
HX_LOCAL_STACK_FRAME(_hx_pos_0484b113da1bcafb_113_get_numTriangles,"flixel.graphics.tile.FlxDrawBaseItem","get_numTriangles",0x6bc74ed1,"flixel.graphics.tile.FlxDrawBaseItem.get_numTriangles","flixel/graphics/tile/FlxDrawBaseItem.hx",113,0xe6349cf4)
...
void FlxDrawBaseItem_obj::reset(){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_84_reset)
HXLINE(  85)		this->graphics = null();
HXLINE(  86)		this->antialiasing = false;
HXLINE(  87)		this->nextTyped = null();
HXLINE(  88)		this->next = null();
            	}
...
void FlxDrawBaseItem_obj::dispose(){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_92_dispose)
HXLINE(  93)		this->graphics = null();
HXLINE(  94)		this->next = null();
HXLINE(  95)		this->type = null();
HXLINE(  96)		this->nextTyped = null();
            	}
...
void FlxDrawBaseItem_obj::render( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_101_render)
HXDLIN( 101)		::flixel::graphics::tile::FlxDrawBaseItem_obj::drawCalls++;
            	}
...
void FlxDrawBaseItem_obj::addQuad( ::flixel::graphics::frames::FlxFrame frame, ::flixel::math::FlxMatrix matrix, ::openfl::geom::ColorTransform transform){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_104_addQuad)
            	}
...
int FlxDrawBaseItem_obj::get_numVertices(){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_108_get_numVertices)
...
int FlxDrawBaseItem_obj::get_numTriangles(){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_113_get_numTriangles)
