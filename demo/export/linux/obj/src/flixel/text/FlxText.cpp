...
HXDLIN( 527)			if (value) {
HXLINE( 527)				_hx_tmp = (int)1;
            			}
            			else {
HXLINE( 527)				_hx_tmp = (int)2;
            			}
...
HXDLIN( 536)			return hx::IsNotEq( this->textField->get_autoSize(),(int)2 );
            		}
            		else {
...
HXDLIN( 553)		return ::Std_obj::_hx_int(this->_defaultFormat->size);
            	}
...
HXLINE( 565)		if (hx::IsEq( this->_defaultFormat->color,((int)Color & (int)(int)16777215) )) {
HXLINE( 567)			return Color;
            		}
HXLINE( 569)		this->_defaultFormat->color = ((int)Color & (int)(int)16777215);
...
HXDLIN( 623)		return this->_defaultFormat->bold;
            	}
...
HXDLIN( 638)		return this->_defaultFormat->italic;
            	}
...
HXLINE( 690)		this->_hasBorderAlpha = (((Float)((int)((int)Color >> (int)(int)24) & (int)(int)255) / (Float)(int)255) < (int)1);
...
HXDLIN( 704)		if ((Value < (int)0)) {
HXLINE( 704)			lowerBound = (int)0;
            		}
            		else {
HXLINE( 704)			lowerBound = Value;
            		}
HXDLIN( 704)		 ::Dynamic Value1;
HXDLIN( 704)		if ((lowerBound > (int)1)) {
HXLINE( 704)			Value1 = (int)1;
            		}
            		else {
HXLINE( 704)			Value1 = lowerBound;
            		}
HXDLIN( 704)		Value = Value1;
...
HXLINE( 755)		int oldWidth = (int)0;
HXLINE( 756)		int oldHeight = (int)4;
...
HXLINE( 766)		Float newHeight = (this->textField->get_textHeight() + (int)4);
HXLINE( 769)		if ((this->textField->get_textHeight() == (int)0)) {
HXLINE( 771)			newHeight = oldHeight;
            		}
...
HXDLIN( 779)			this->makeGraphic(_hx_tmp2,::Std_obj::_hx_int(newHeight),(int)0,false,key);
...
HXLINE( 802)			_hx_tmp4 = (::lime::text::_UTF8String::UTF8String_Impl__obj::get_length(this->textField->get_text()) > (int)0);
            		}
            		else {
...
HXLINE( 995)				int _hx_tmp1 = (::lime::text::_UTF8String::UTF8String_Impl__obj::get_length(this->textField->get_text()) - (int)1);
...
HXLINE(1007)				_hx_tmp3->setTextFormat(FormatAdjusted,formatRange1,::Std_obj::_hx_int(::Math_obj::min(formatRange2,::lime::text::_UTF8String::UTF8String_Impl__obj::get_length(this->textField->get_text()))));
            			}
            			_hx_goto_59:;
            		}
            	}
