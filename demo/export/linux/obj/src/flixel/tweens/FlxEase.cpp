...
HXDLIN(  25)		B1 = ((Float)0.363636363636363646);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a9a0b53a43037f15_26_boot)
HXDLIN(  26)		B2 = ((Float)0.727272727272727293);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a9a0b53a43037f15_27_boot)
HXDLIN(  27)		B3 = ((Float)0.545454545454545414);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a9a0b53a43037f15_28_boot)
HXDLIN(  28)		B4 = ((Float)0.909090909090909061);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a9a0b53a43037f15_29_boot)
HXDLIN(  29)		B5 = ((Float)0.818181818181818232);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a9a0b53a43037f15_30_boot)
HXDLIN(  30)		B6 = ((Float)0.954545454545454586);
            	}
{
