...
HX_LOCAL_STACK_FRAME(_hx_pos_cceaeff5e596bc9e_474_set_x,"flixel.math.FlxPoint","set_x",0x1a631e5f,"flixel.math.FlxPoint.set_x","flixel/math/FlxPoint.hx",474,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_cceaeff5e596bc9e_482_set_y,"flixel.math.FlxPoint","set_y",0x1a631e60,"flixel.math.FlxPoint.set_y","flixel/math/FlxPoint.hx",482,0xb3e1cd2c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_cceaeff5e596bc9e_487_get_pool,"flixel.math.FlxPoint","get_pool",0xa55c73e1,"flixel.math.FlxPoint.get_pool","flixel/math/FlxPoint.hx",487,0xb3e1cd2c)
...
HXLINE( 465)		 ::Dynamic value = this->x;
HXDLIN( 465)		 ::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 465)		_this->label = HX_("x",78,00,00,00);
HXDLIN( 465)		_this->value = value;
HXDLIN( 465)		 ::flixel::util::LabelValuePair _hx_tmp = _this;
HXLINE( 466)		 ::Dynamic value1 = this->y;
HXDLIN( 466)		 ::flixel::util::LabelValuePair _this1 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 466)		_this1->label = HX_("y",79,00,00,00);
HXDLIN( 466)		_this1->value = value1;
HXLINE( 464)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(2)->init(0,_hx_tmp)->init(1,_this1));
            	}
...
Float FlxPoint_obj::set_x(Float Value){
            	HX_STACKFRAME(&_hx_pos_cceaeff5e596bc9e_474_set_x)
HXDLIN( 474)		return (this->x = Value);
            	}
...
Float FlxPoint_obj::set_y(Float Value){
            	HX_STACKFRAME(&_hx_pos_cceaeff5e596bc9e_482_set_y)
HXDLIN( 482)		return (this->y = Value);
            	}
...
::Dynamic FlxPoint_obj::get_pool(){
            	HX_STACKFRAME(&_hx_pos_cceaeff5e596bc9e_487_get_pool)
HXDLIN( 487)		return ::flixel::math::FlxPoint_obj::_pool;
            	}
