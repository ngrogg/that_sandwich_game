...
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_643_gameStart,"flixel.FlxGame","gameStart",0x0d0c34f4,"flixel.FlxGame.gameStart","flixel/FlxGame.hx",643,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_655_step,"flixel.FlxGame","step",0xd28f5fe8,"flixel.FlxGame.step","flixel/FlxGame.hx",655,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_678_handleReplayRequests,"flixel.FlxGame","handleReplayRequests",0xefa2c6ef,"flixel.FlxGame.handleReplayRequests","flixel/FlxGame.hx",678,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_712_update,"flixel.FlxGame","update",0x9b7d5da5,"flixel.FlxGame.update","flixel/FlxGame.hx",712,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_758_updateElapsed,"flixel.FlxGame","updateElapsed",0x372d9117,"flixel.FlxGame.updateElapsed","flixel/FlxGame.hx",758,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_817_updateInput,"flixel.FlxGame","updateInput",0x1a1f4025,"flixel.FlxGame.updateInput","flixel/FlxGame.hx",817,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_836_draw,"flixel.FlxGame","draw",0xc8a3a4a0,"flixel.FlxGame.draw","flixel/FlxGame.hx",836,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_881_getTicks,"flixel.FlxGame","getTicks",0x73d7349c,"flixel.FlxGame.getTicks","flixel/FlxGame.hx",881,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_887___default_getTimer,"flixel.FlxGame","__default_getTimer",0xda03b289,"flixel.FlxGame.__default_getTimer","flixel/FlxGame.hx",887,0x34f39fed)
namespace flixel{
...
HXLINE( 259)		this->_inputContainer =  ::openfl::display::Sprite_obj::__alloc( HX_CTX );
HXLINE( 261)		if ((GameWidth == (int)0)) {
HXLINE( 262)			GameWidth = ::openfl::Lib_obj::get_current()->stage->stageWidth;
            		}
HXLINE( 263)		if ((GameHeight == (int)0)) {
HXLINE( 264)			GameHeight = ::openfl::Lib_obj::get_current()->stage->stageHeight;
            		}
...
HXLINE( 297)		if (hx::IsNull( this->stage )) {
HXLINE( 298)			return;
            		}
...
HXLINE( 310)		this->stage->set_scaleMode((int)2);
...
HXLINE( 336)		this->_focusLostScreen = ( ( ::flixel::_hx_system::ui::FlxFocusLostScreen)(::Type_obj::createInstance(this->_customFocusLostScreen,::cpp::VirtualArray_obj::__new(0))) );
HXLINE( 337)		this->addChild(this->_focusLostScreen);
HXLINE( 346)		this->stage->addEventListener(HX_("deactivate",34,5c,01,3c),this->onFocusLost_dyn(),null(),null(),null());
HXLINE( 347)		this->stage->addEventListener(HX_("activate",b3,1b,ac,e5),this->onFocus_dyn(),null(),null(),null());
HXLINE( 351)		{
...
HXLINE( 366)		int _hx_tmp2 = ::openfl::Lib_obj::get_current()->stage->stageWidth;
HXDLIN( 366)		this->resizeGame(_hx_tmp2,::openfl::Lib_obj::get_current()->stage->stageHeight);
HXLINE( 368)		::openfl::utils::Assets_obj::addEventListener(HX_("change",70,91,72,b7),::flixel::FlxG_obj::bitmap->onAssetsReload_dyn(),null(),null(),null());
            	}
...
HXLINE( 453)		int width = ::openfl::Lib_obj::get_current()->stage->stageWidth;
HXLINE( 454)		int height = ::openfl::Lib_obj::get_current()->stage->stageHeight;
...
HXLINE( 609)		::flixel::FlxG_obj::signals->preStateSwitch->dispatch();
...
HXLINE( 625)		if (this->_gameJustStarted) {
HXLINE( 626)			::flixel::FlxG_obj::signals->preGameStart->dispatch();
            		}
HXLINE( 628)		::flixel::FlxG_obj::signals->preStateCreate->dispatch(this->_state);
HXLINE( 630)		this->_state->create();
HXLINE( 632)		if (this->_gameJustStarted) {
HXLINE( 633)			this->gameStart();
            		}
HXLINE( 639)		::flixel::FlxG_obj::signals->postStateSwitch->dispatch();
            	}
...
void FlxGame_obj::gameStart(){
            	HX_STACKFRAME(&_hx_pos_ad2b8ce2bfb1aa86_643_gameStart)
HXLINE( 644)		::flixel::FlxG_obj::signals->postGameStart->dispatch();
HXLINE( 645)		this->_gameJustStarted = false;
            	}
...
void FlxGame_obj::step(){
            	HX_GC_STACKFRAME(&_hx_pos_ad2b8ce2bfb1aa86_655_step)
HXLINE( 657)		if (this->_resetGame) {
HXLINE( 659)			{
HXLINE( 659)				::flixel::FlxG_obj::signals->preGameReset->dispatch();
HXDLIN( 659)				bool _hx_tmp;
HXDLIN( 659)				if (!(this->_skipSplash)) {
HXLINE( 659)					_hx_tmp = hx::IsNotNull( ::flixel::_hx_system::FlxSplash_obj::nextState );
            				}
            				else {
HXLINE( 659)					_hx_tmp = true;
            				}
HXDLIN( 659)				if (_hx_tmp) {
HXLINE( 659)					this->_requestedState = ( ( ::flixel::FlxState)(::Type_obj::createInstance(this->_initialState,::cpp::VirtualArray_obj::__new(0))) );
HXDLIN( 659)					if (hx::IsNull( ::flixel::_hx_system::FlxSplash_obj::nextState )) {
HXLINE( 659)						this->_gameJustStarted = true;
            					}
            				}
            				else {
HXLINE( 659)					::flixel::_hx_system::FlxSplash_obj::nextState = this->_initialState;
HXDLIN( 659)					this->_requestedState =  ::flixel::_hx_system::FlxSplash_obj::__alloc( HX_CTX ,null());
HXDLIN( 659)					this->_skipSplash = true;
            				}
HXDLIN( 659)				::flixel::FlxG_obj::reset();
HXDLIN( 659)				::flixel::FlxG_obj::signals->postGameReset->dispatch();
            			}
HXLINE( 660)			this->_resetGame = false;
            		}
HXLINE( 663)		this->handleReplayRequests();
HXLINE( 670)		this->update();
            	}
...
void FlxGame_obj::handleReplayRequests(){
            	HX_STACKFRAME(&_hx_pos_ad2b8ce2bfb1aa86_678_handleReplayRequests)
            	}
...
void FlxGame_obj::update(){
            	HX_STACKFRAME(&_hx_pos_ad2b8ce2bfb1aa86_712_update)
HXLINE( 713)		bool _hx_tmp;
HXDLIN( 713)		if (!(!(this->_state->active))) {
HXLINE( 713)			_hx_tmp = !(this->_state->exists);
            		}
            		else {
...
HXLINE( 716)		if (hx::IsNotEq( this->_state,this->_requestedState )) {
HXLINE( 717)			this->switchState();
            		}
HXLINE( 724)		this->updateElapsed();
HXLINE( 726)		::flixel::FlxG_obj::signals->preUpdate->dispatch();
HXLINE( 728)		this->updateInput();
HXLINE( 736)		::flixel::FlxG_obj::sound->update(::flixel::FlxG_obj::elapsed);
HXLINE( 738)		{
HXLINE( 738)			Float elapsed = ::flixel::FlxG_obj::elapsed;
HXDLIN( 738)			{
HXLINE( 738)				int _g = (int)0;
HXDLIN( 738)				::Array< ::Dynamic> _g1 = ::flixel::FlxG_obj::plugins->list;
HXDLIN( 738)				while((_g < _g1->length)){
HXLINE( 738)					 ::flixel::FlxBasic plugin = _g1->__get(_g).StaticCast<  ::flixel::FlxBasic >();
HXDLIN( 738)					_g = (_g + (int)1);
HXDLIN( 738)					bool _hx_tmp1;
HXDLIN( 738)					if (plugin->exists) {
HXLINE( 738)						_hx_tmp1 = plugin->active;
            					}
            					else {
HXLINE( 738)						_hx_tmp1 = false;
            					}
HXDLIN( 738)					if (_hx_tmp1) {
HXLINE( 738)						plugin->update(elapsed);
            					}
            				}
            			}
            		}
HXLINE( 740)		this->_state->tryUpdate(::flixel::FlxG_obj::elapsed);
HXLINE( 742)		{
HXLINE( 742)			Float elapsed1 = ::flixel::FlxG_obj::elapsed;
HXDLIN( 742)			{
HXLINE( 742)				int _g2 = (int)0;
HXDLIN( 742)				::Array< ::Dynamic> _g11 = ::flixel::FlxG_obj::cameras->list;
HXDLIN( 742)				while((_g2 < _g11->length)){
HXLINE( 742)					 ::flixel::FlxCamera camera = _g11->__get(_g2).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 742)					_g2 = (_g2 + (int)1);
HXDLIN( 742)					bool _hx_tmp2;
HXDLIN( 742)					bool _hx_tmp3;
HXDLIN( 742)					if (hx::IsNotNull( camera )) {
HXLINE( 742)						_hx_tmp3 = camera->exists;
            					}
            					else {
HXLINE( 742)						_hx_tmp3 = false;
            					}
HXDLIN( 742)					if (_hx_tmp3) {
HXLINE( 742)						_hx_tmp2 = camera->active;
            					}
            					else {
HXLINE( 742)						_hx_tmp2 = false;
            					}
HXDLIN( 742)					if (_hx_tmp2) {
HXLINE( 742)						camera->update(elapsed1);
            					}
            				}
            			}
            		}
HXLINE( 743)		::flixel::FlxG_obj::signals->postUpdate->dispatch();
HXLINE( 750)		::flixel::util::FlxArrayUtil_obj::clearArray(::flixel::FlxG_obj::swipes,null());
HXLINE( 753)		::Array< ::Dynamic> _hx_tmp4;
HXDLIN( 753)		if (this->filtersEnabled) {
HXLINE( 753)			_hx_tmp4 = this->_filters;
            		}
            		else {
HXLINE( 753)			_hx_tmp4 = null();
            		}
HXDLIN( 753)		this->set_filters(_hx_tmp4);
            	}
...
void FlxGame_obj::updateElapsed(){
            	HX_STACKFRAME(&_hx_pos_ad2b8ce2bfb1aa86_758_updateElapsed)
HXDLIN( 758)		if (::flixel::FlxG_obj::fixedTimestep) {
HXLINE( 760)			::flixel::FlxG_obj::elapsed = (::flixel::FlxG_obj::timeScale * this->_stepSeconds);
            		}
            		else {
HXLINE( 764)			Float _hx_tmp = ::flixel::FlxG_obj::timeScale;
HXDLIN( 764)			::flixel::FlxG_obj::elapsed = (_hx_tmp * ((Float)this->_elapsedMS / (Float)(int)1000));
HXLINE( 766)			Float max = (::flixel::FlxG_obj::maxElapsed * ::flixel::FlxG_obj::timeScale);
HXLINE( 767)			if ((::flixel::FlxG_obj::elapsed > max)) {
HXLINE( 768)				::flixel::FlxG_obj::elapsed = max;
            			}
            		}
            	}
...
void FlxGame_obj::updateInput(){
            	HX_STACKFRAME(&_hx_pos_ad2b8ce2bfb1aa86_817_updateInput)
HXDLIN( 817)		int _g = (int)0;
HXDLIN( 817)		::Array< ::Dynamic> _g1 = ::flixel::FlxG_obj::inputs->list;
HXDLIN( 817)		while((_g < _g1->length)){
HXDLIN( 817)			::Dynamic input = _g1->__get(_g);
HXDLIN( 817)			_g = (_g + (int)1);
HXDLIN( 817)			::flixel::input::IFlxInputManager_obj::update(input);
            		}
            	}
...
void FlxGame_obj::draw(){
            	HX_STACKFRAME(&_hx_pos_ad2b8ce2bfb1aa86_836_draw)
HXLINE( 837)		bool _hx_tmp;
HXDLIN( 837)		if (!(!(this->_state->visible))) {
HXLINE( 837)			_hx_tmp = !(this->_state->exists);
            		}
            		else {
...
HXLINE( 845)		::flixel::FlxG_obj::signals->preDraw->dispatch();
HXLINE( 847)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 848)			::flixel::graphics::tile::FlxDrawBaseItem_obj::drawCalls = (int)0;
            		}
HXLINE( 855)		{
HXLINE( 855)			 ::flixel::_hx_system::frontEnds::CameraFrontEnd _this = ::flixel::FlxG_obj::cameras;
HXDLIN( 855)			{
HXLINE( 855)				int _g = (int)0;
HXDLIN( 855)				::Array< ::Dynamic> _g1 = _this->list;
HXDLIN( 855)				while((_g < _g1->length)){
HXLINE( 855)					 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 855)					_g = (_g + (int)1);
HXDLIN( 855)					bool _hx_tmp1;
HXDLIN( 855)					bool _hx_tmp2;
HXDLIN( 855)					if (hx::IsNotNull( camera )) {
...
HXLINE( 855)						_hx_tmp1 = !(camera->visible);
            					}
            					else {
...
HXDLIN( 855)					if (::flixel::FlxG_obj::renderBlit) {
HXLINE( 855)						camera->checkResize();
HXDLIN( 855)						if (_this->useBufferLocking) {
HXLINE( 855)							camera->buffer->lock();
            						}
            					}
HXDLIN( 855)					if (::flixel::FlxG_obj::renderTile) {
HXLINE( 855)						camera->clearDrawStack();
HXDLIN( 855)						camera->canvas->get_graphics()->clear();
            					}
HXDLIN( 855)					if (::flixel::FlxG_obj::renderBlit) {
HXLINE( 855)						camera->fill(camera->bgColor,camera->useBgAlphaBlending,null(),null());
HXDLIN( 855)						camera->screen->dirty = true;
            					}
            					else {
HXLINE( 855)						camera->fill(((int)camera->bgColor & (int)(int)16777215),camera->useBgAlphaBlending,((Float)((int)((int)camera->bgColor >> (int)(int)24) & (int)(int)255) / (Float)(int)255),null());
            					}
            				}
            			}
            		}
HXLINE( 857)		{
HXLINE( 857)			int _g2 = (int)0;
HXDLIN( 857)			::Array< ::Dynamic> _g11 = ::flixel::FlxG_obj::plugins->list;
HXDLIN( 857)			while((_g2 < _g11->length)){
HXLINE( 857)				 ::flixel::FlxBasic plugin = _g11->__get(_g2).StaticCast<  ::flixel::FlxBasic >();
HXDLIN( 857)				_g2 = (_g2 + (int)1);
HXDLIN( 857)				bool _hx_tmp3;
HXDLIN( 857)				if (plugin->exists) {
HXLINE( 857)					_hx_tmp3 = plugin->visible;
            				}
            				else {
HXLINE( 857)					_hx_tmp3 = false;
            				}
HXDLIN( 857)				if (_hx_tmp3) {
HXLINE( 857)					plugin->draw();
            				}
            			}
            		}
HXLINE( 859)		this->_state->draw();
HXLINE( 861)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 863)			if (::flixel::FlxG_obj::renderTile) {
HXLINE( 863)				int _g3 = (int)0;
HXDLIN( 863)				::Array< ::Dynamic> _g12 = ::flixel::FlxG_obj::cameras->list;
HXDLIN( 863)				while((_g3 < _g12->length)){
HXLINE( 863)					 ::flixel::FlxCamera camera1 = _g12->__get(_g3).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 863)					_g3 = (_g3 + (int)1);
HXDLIN( 863)					bool _hx_tmp4;
HXDLIN( 863)					bool _hx_tmp5;
HXDLIN( 863)					if (hx::IsNotNull( camera1 )) {
HXLINE( 863)						_hx_tmp5 = camera1->exists;
            					}
            					else {
HXLINE( 863)						_hx_tmp5 = false;
            					}
HXDLIN( 863)					if (_hx_tmp5) {
HXLINE( 863)						_hx_tmp4 = camera1->visible;
            					}
            					else {
HXLINE( 863)						_hx_tmp4 = false;
            					}
HXDLIN( 863)					if (_hx_tmp4) {
HXLINE( 863)						camera1->render();
            					}
            				}
            			}
            		}
HXLINE( 870)		{
HXLINE( 870)			 ::flixel::_hx_system::frontEnds::CameraFrontEnd _this1 = ::flixel::FlxG_obj::cameras;
HXDLIN( 870)			{
HXLINE( 870)				int _g4 = (int)0;
HXDLIN( 870)				::Array< ::Dynamic> _g13 = _this1->list;
HXDLIN( 870)				while((_g4 < _g13->length)){
HXLINE( 870)					 ::flixel::FlxCamera camera2 = _g13->__get(_g4).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 870)					_g4 = (_g4 + (int)1);
HXDLIN( 870)					bool _hx_tmp6;
HXDLIN( 870)					bool _hx_tmp7;
HXDLIN( 870)					if (hx::IsNotNull( camera2 )) {
HXLINE( 870)						_hx_tmp7 = !(camera2->exists);
            					}
            					else {
HXLINE( 870)						_hx_tmp7 = true;
            					}
HXDLIN( 870)					if (!(_hx_tmp7)) {
HXLINE( 870)						_hx_tmp6 = !(camera2->visible);
            					}
            					else {
HXLINE( 870)						_hx_tmp6 = true;
            					}
HXDLIN( 870)					if (_hx_tmp6) {
HXLINE( 870)						continue;
            					}
HXDLIN( 870)					camera2->drawFX();
HXDLIN( 870)					if (::flixel::FlxG_obj::renderBlit) {
HXLINE( 870)						if (_this1->useBufferLocking) {
HXLINE( 870)							camera2->buffer->unlock(null());
            						}
HXDLIN( 870)						camera2->screen->dirty = true;
            					}
            				}
            			}
            		}
HXLINE( 872)		::flixel::FlxG_obj::signals->postDraw->dispatch();
            	}
...
int FlxGame_obj::getTicks(){
            	HX_STACKFRAME(&_hx_pos_ad2b8ce2bfb1aa86_881_getTicks)
HXDLIN( 881)		int _hx_tmp = ( (int)(this->getTimer()) );
HXDLIN( 881)		return (_hx_tmp - this->_startTime);
            	}
...
int _hx_run(){
            	HX_STACKFRAME(&_hx_pos_ad2b8ce2bfb1aa86_887___default_getTimer)
HXDLIN( 887)		return ::openfl::Lib_obj::getTimer();
            	}
