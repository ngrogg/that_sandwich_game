...
HX_LOCAL_STACK_FRAME(_hx_pos_cfd221447aa7194b_1319_set_flipX,"flixel.FlxSprite","set_flipX",0xf4d45525,"flixel.FlxSprite.set_flipX","flixel/FlxSprite.hx",1319,0x0384bffa)
HX_LOCAL_STACK_FRAME(_hx_pos_cfd221447aa7194b_1330_set_flipY,"flixel.FlxSprite","set_flipY",0xf4d45526,"flixel.FlxSprite.set_flipY","flixel/FlxSprite.hx",1330,0x0384bffa)
HX_LOCAL_STACK_FRAME(_hx_pos_cfd221447aa7194b_1342_set_antialiasing,"flixel.FlxSprite","set_antialiasing",0xf8f29e1a,"flixel.FlxSprite.set_antialiasing","flixel/FlxSprite.hx",1342,0x0384bffa)
HX_LOCAL_STACK_FRAME(_hx_pos_cfd221447aa7194b_1348_set_useFramePixels,"flixel.FlxSprite","set_useFramePixels",0x72e62ad9,"flixel.FlxSprite.set_useFramePixels","flixel/FlxSprite.hx",1348,0x0384bffa)
HX_LOCAL_STACK_FRAME(_hx_pos_cfd221447aa7194b_1372_checkFlipX,"flixel.FlxSprite","checkFlipX",0x26093f8c,"flixel.FlxSprite.checkFlipX","flixel/FlxSprite.hx",1372,0x0384bffa)
HX_LOCAL_STACK_FRAME(_hx_pos_cfd221447aa7194b_1383_checkFlipY,"flixel.FlxSprite","checkFlipY",0x26093f8d,"flixel.FlxSprite.checkFlipY","flixel/FlxSprite.hx",1383,0x0384bffa)
namespace flixel{
...
HXLINE( 259)		this->_flashPoint =  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null());
HXLINE( 260)		this->_flashRect =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
HXLINE( 261)		this->_flashRect2 =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
HXLINE( 262)		this->_flashPointZero =  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 268)		this->colorTransform =  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
            	}
...
HXLINE( 409)		 ::openfl::display::BitmapData brush = brushGraphic->bitmap;
HXLINE( 410)		::String key = brushGraphic->key;
HXLINE( 412)		if ((Frame >= (int)0)) {
HXLINE( 415)			int brushSize = brush->height;
HXLINE( 416)			int framesNum = ::Std_obj::_hx_int(((Float)brush->width / (Float)brushSize));
...
HXLINE( 420)			 ::openfl::display::BitmapData full = brush;
HXLINE( 421)			brush =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,brushSize,brushSize,true,(int)0);
HXLINE( 422)			 ::openfl::geom::Rectangle _hx_tmp = this->_flashRect;
...
HXLINE( 432)			 ::openfl::display::BitmapData bitmap = ::flixel::util::FlxBitmapDataUtil_obj::generateRotations(brush,Rotations,AntiAliasing,AutoBuffer);
...
HXDLIN( 681)			 ::openfl::geom::Point FlashPoint = this->_flashPoint;
HXDLIN( 681)			if (hx::IsNull( FlashPoint )) {
HXLINE( 681)				FlashPoint =  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null());
            			}
...
HXLINE( 728)		 ::openfl::display::BitmapData bitmapData = Brush->framePixels;
...
HXLINE( 750)			 ::Dynamic brushBlend = Brush->blend;
...
HXLINE( 855)			this->colorTransform =  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
            		}
...
HXLINE( 894)			 ::openfl::display::BitmapData frameData = this->updateFramePixels();
...
bool FlxSprite_obj::set_flipX(bool Value){
            	HX_STACKFRAME(&_hx_pos_cfd221447aa7194b_1319_set_flipX)
HXLINE(1320)		if (::flixel::FlxG_obj::renderTile) {
HXLINE(1322)			int _hx_tmp;
HXDLIN(1322)			if (Value) {
HXLINE(1322)				_hx_tmp = (int)-1;
            			}
            			else {
HXLINE(1322)				_hx_tmp = (int)1;
            			}
HXDLIN(1322)			this->_facingHorizontalMult = _hx_tmp;
            		}
HXLINE(1324)		bool _hx_tmp1;
HXDLIN(1324)		if ((this->flipX == Value)) {
HXLINE(1324)			_hx_tmp1 = this->dirty;
            		}
            		else {
HXLINE(1324)			_hx_tmp1 = true;
            		}
HXDLIN(1324)		this->dirty = _hx_tmp1;
HXLINE(1325)		return (this->flipX = Value);
            	}
...
bool FlxSprite_obj::set_flipY(bool Value){
            	HX_STACKFRAME(&_hx_pos_cfd221447aa7194b_1330_set_flipY)
HXLINE(1331)		if (::flixel::FlxG_obj::renderTile) {
HXLINE(1333)			int _hx_tmp;
HXDLIN(1333)			if (Value) {
HXLINE(1333)				_hx_tmp = (int)-1;
            			}
            			else {
HXLINE(1333)				_hx_tmp = (int)1;
            			}
HXDLIN(1333)			this->_facingVerticalMult = _hx_tmp;
            		}
HXLINE(1335)		bool _hx_tmp1;
HXDLIN(1335)		if ((this->flipY == Value)) {
HXLINE(1335)			_hx_tmp1 = this->dirty;
            		}
            		else {
HXLINE(1335)			_hx_tmp1 = true;
            		}
HXDLIN(1335)		this->dirty = _hx_tmp1;
HXLINE(1336)		return (this->flipY = Value);
            	}
...
bool FlxSprite_obj::set_antialiasing(bool value){
            	HX_STACKFRAME(&_hx_pos_cfd221447aa7194b_1342_set_antialiasing)
HXDLIN(1342)		return (this->antialiasing = value);
            	}
...
bool FlxSprite_obj::set_useFramePixels(bool value){
            	HX_STACKFRAME(&_hx_pos_cfd221447aa7194b_1348_set_useFramePixels)
HXDLIN(1348)		if (::flixel::FlxG_obj::renderTile) {
HXLINE(1350)			if ((value != this->useFramePixels)) {
HXLINE(1352)				this->useFramePixels = value;
HXLINE(1353)				this->set_frame(this->frame);
HXLINE(1355)				if (value) {
HXLINE(1357)					this->updateFramePixels();
            				}
            			}
HXLINE(1361)			return value;
            		}
            		else {
HXLINE(1365)			this->useFramePixels = true;
...
bool FlxSprite_obj::checkFlipX(){
            	HX_STACKFRAME(&_hx_pos_cfd221447aa7194b_1372_checkFlipX)
HXLINE(1373)		bool doFlipX = (this->flipX != this->_frame->flipX);
HXLINE(1374)		if (hx::IsNotNull( this->animation->_curAnim )) {
HXLINE(1376)			return (doFlipX != this->animation->_curAnim->flipX);
            		}
HXLINE(1378)		return doFlipX;
            	}
...
bool FlxSprite_obj::checkFlipY(){
            	HX_STACKFRAME(&_hx_pos_cfd221447aa7194b_1383_checkFlipY)
HXLINE(1384)		bool doFlipY = (this->flipY != this->_frame->flipY);
HXLINE(1385)		if (hx::IsNotNull( this->animation->_curAnim )) {
HXLINE(1387)			return (doFlipY != this->animation->_curAnim->flipY);
            		}
HXLINE(1389)		return doFlipY;
            	}
