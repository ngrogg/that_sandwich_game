...
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_353_loadText,"lime._internal.backend.native.NativeHTTPRequest","loadText",0xbea62643,"lime._internal.backend.native.NativeHTTPRequest.loadText","lime/_internal/backend/native/NativeHTTPRequest.hx",353,0xfe6a4b7e)
...
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_372_growBuffer,"lime._internal.backend.native.NativeHTTPRequest","growBuffer",0x377519c3,"lime._internal.backend.native.NativeHTTPRequest.growBuffer","lime/_internal/backend/native/NativeHTTPRequest.hx",372,0xfe6a4b7e)
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_390_curl_onHeader,"lime._internal.backend.native.NativeHTTPRequest","curl_onHeader",0xe5ba44af,"lime._internal.backend.native.NativeHTTPRequest.curl_onHeader","lime/_internal/backend/native/NativeHTTPRequest.hx",390,0xfe6a4b7e)
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_403_curl_onProgress,"lime._internal.backend.native.NativeHTTPRequest","curl_onProgress",0xbe43bf4f,"lime._internal.backend.native.NativeHTTPRequest.curl_onProgress","lime/_internal/backend/native/NativeHTTPRequest.hx",403,0xfe6a4b7e)
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_421_curl_onWrite,"lime._internal.backend.native.NativeHTTPRequest","curl_onWrite",0x97fe6bfd,"lime._internal.backend.native.NativeHTTPRequest.curl_onWrite","lime/_internal/backend/native/NativeHTTPRequest.hx",421,0xfe6a4b7e)
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_433_multiTimer_onRun,"lime._internal.backend.native.NativeHTTPRequest","multiTimer_onRun",0xeebe9a89,"lime._internal.backend.native.NativeHTTPRequest.multiTimer_onRun","lime/_internal/backend/native/NativeHTTPRequest.hx",433,0xfe6a4b7e)
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_507_threadPool_doWork,"lime._internal.backend.native.NativeHTTPRequest","threadPool_doWork",0x74d11645,"lime._internal.backend.native.NativeHTTPRequest.threadPool_doWork","lime/_internal/backend/native/NativeHTTPRequest.hx",507,0xfe6a4b7e)
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_552_threadPool_onComplete,"lime._internal.backend.native.NativeHTTPRequest","threadPool_onComplete",0x5df31cc1,"lime._internal.backend.native.NativeHTTPRequest.threadPool_onComplete","lime/_internal/backend/native/NativeHTTPRequest.hx",552,0xfe6a4b7e)
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_573_threadPool_onError,"lime._internal.backend.native.NativeHTTPRequest","threadPool_onError",0xc9f85ac0,"lime._internal.backend.native.NativeHTTPRequest.threadPool_onError","lime/_internal/backend/native/NativeHTTPRequest.hx",573,0xfe6a4b7e)
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_593_threadPool_onProgress,"lime._internal.backend.native.NativeHTTPRequest","threadPool_onProgress",0x645613b5,"lime._internal.backend.native.NativeHTTPRequest.threadPool_onProgress","lime/_internal/backend/native/NativeHTTPRequest.hx",593,0xfe6a4b7e)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
HXLINE( 328)					::lime::_internal::backend::native::NativeHTTPRequest_obj::multiTimer =  ::haxe::Timer_obj::__alloc( HX_CTX ,(int)8);
HXLINE( 329)					::lime::_internal::backend::native::NativeHTTPRequest_obj::multiTimer->run = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multiTimer_onRun_dyn();
HXLINE( 330)					::lime::_internal::backend::native::NativeHTTPRequest_obj::multiTimer_onRun();
            				}
            			}
            		}
...
HX_DEFINE_DYNAMIC_FUNC2(NativeHTTPRequest_obj,loadData,return )
 ...
 ::lime::app::Future NativeHTTPRequest_obj::loadText(::String uri){
            		...
            		void _hx_run( ::haxe::io::Bytes bytes){
            			HX_GC_STACKFRAME(&_hx_pos_11449fe5de606ab4_353_loadText)
HXLINE( 353)			if (hx::IsNull( bytes )) {
HXLINE( 355)				promise->complete(null());
            			}
            			else {
HXLINE( 359)				::String _hx_tmp = bytes->getString((int)0,bytes->length,null());
...
void NativeHTTPRequest_obj::growBuffer(int length){
            	HX_STACKFRAME(&_hx_pos_11449fe5de606ab4_372_growBuffer)
HXDLIN( 372)		if ((length > this->bytes->length)) {
HXLINE( 374)			 ::haxe::io::Bytes cacheBytes = this->bytes;
HXLINE( 375)			this->bytes = ::haxe::io::Bytes_obj::alloc(length);
HXLINE( 376)			this->bytes->blit((int)0,cacheBytes,(int)0,cacheBytes->length);
            		}
            	}
...
void NativeHTTPRequest_obj::curl_onHeader( ::lime::net::curl::CURL curl,::String header){
            	HX_GC_STACKFRAME(&_hx_pos_11449fe5de606ab4_390_curl_onHeader)
HXLINE( 392)		::Array< ::String > parts = header.split(HX_(": ",a6,32,00,00));
HXLINE( 394)		if ((parts->length == (int)2)) {
HXLINE( 396)			::Array< ::Dynamic> _hx_tmp = ( (::Array< ::Dynamic>)(this->parent->__Field(HX_("responseHeaders",c5,0d,ca,43),hx::paccDynamic)) );
HXDLIN( 396)			::String _hx_tmp1 = ::StringTools_obj::trim(parts->__get((int)0));
HXDLIN( 396)			_hx_tmp->push( ::lime::net::HTTPRequestHeader_obj::__alloc( HX_CTX ,_hx_tmp1,::StringTools_obj::trim(parts->__get((int)1))));
            		}
            	}
...
int NativeHTTPRequest_obj::curl_onProgress( ::lime::net::curl::CURL curl,int dltotal,int dlnow,int uptotal,int upnow){
            	HX_STACKFRAME(&_hx_pos_11449fe5de606ab4_403_curl_onProgress)
HXLINE( 405)		bool _hx_tmp;
HXDLIN( 405)		bool _hx_tmp1;
HXDLIN( 405)		bool _hx_tmp2;
HXDLIN( 405)		if ((upnow <= this->bytesLoaded)) {
HXLINE( 405)			_hx_tmp2 = (dlnow > this->bytesLoaded);
            		}
            		else {
HXLINE( 405)			_hx_tmp2 = true;
            		}
HXDLIN( 405)		if (!(_hx_tmp2)) {
HXLINE( 405)			_hx_tmp1 = (uptotal > this->bytesTotal);
            		}
            		else {
HXLINE( 405)			_hx_tmp1 = true;
            		}
HXDLIN( 405)		if (!(_hx_tmp1)) {
HXLINE( 405)			_hx_tmp = (dltotal > this->bytesTotal);
            		}
            		else {
HXLINE( 405)			_hx_tmp = true;
            		}
HXDLIN( 405)		if (_hx_tmp) {
HXLINE( 407)			if ((upnow > this->bytesLoaded)) {
HXLINE( 407)				this->bytesLoaded = upnow;
            			}
HXLINE( 408)			if ((dlnow > this->bytesLoaded)) {
HXLINE( 408)				this->bytesLoaded = dlnow;
            			}
HXLINE( 409)			if ((uptotal > this->bytesTotal)) {
HXLINE( 409)				this->bytesTotal = uptotal;
            			}
HXLINE( 410)			if ((dltotal > this->bytesTotal)) {
HXLINE( 410)				this->bytesTotal = dltotal;
            			}
HXLINE( 412)			this->promise->progress(this->bytesLoaded,this->bytesTotal);
            		}
HXLINE( 416)		return (int)0;
            	}
...
int NativeHTTPRequest_obj::curl_onWrite( ::lime::net::curl::CURL curl, ::haxe::io::Bytes output){
            	HX_STACKFRAME(&_hx_pos_11449fe5de606ab4_421_curl_onWrite)
HXLINE( 423)		this->growBuffer((this->writePosition + output->length));
HXLINE( 424)		this->bytes->blit(this->writePosition,output,(int)0,output->length);
HXLINE( 426)		 ::lime::_internal::backend::native::NativeHTTPRequest _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 426)		_hx_tmp->writePosition = (_hx_tmp->writePosition + output->length);
HXLINE( 428)		return output->length;
            	}
...
void NativeHTTPRequest_obj::multiTimer_onRun(){
            	HX_STACKFRAME(&_hx_pos_11449fe5de606ab4_433_multiTimer_onRun)
HXLINE( 435)		::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->perform();
HXLINE( 437)		 ::lime::net::curl::CURLMultiMessage message = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->infoRead();
HXLINE( 438)		 ::lime::net::curl::CURL curl;
HXDLIN( 438)		 ::lime::_internal::backend::native::NativeHTTPRequest instance;
HXDLIN( 438)		int status;
HXLINE( 440)		bool _hx_tmp;
HXDLIN( 440)		if (hx::IsNull( message )) {
HXLINE( 440)			_hx_tmp = (::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->get_runningHandles() == (int)0);
            		}
            		else {
HXLINE( 440)			_hx_tmp = false;
            		}
HXDLIN( 440)		if (_hx_tmp) {
HXLINE( 442)			::lime::_internal::backend::native::NativeHTTPRequest_obj::multiTimer->stop();
HXLINE( 443)			::lime::_internal::backend::native::NativeHTTPRequest_obj::multiTimer = null();
            		}
HXLINE( 447)		while(hx::IsNotNull( message )){
HXLINE( 449)			curl = message->curl;
HXLINE( 451)			if (::lime::_internal::backend::native::NativeHTTPRequest_obj::multiInstances->exists(curl)) {
HXLINE( 453)				instance = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multiInstances->get(curl).StaticCast<  ::lime::_internal::backend::native::NativeHTTPRequest >();
HXLINE( 454)				::lime::_internal::backend::native::NativeHTTPRequest_obj::multiInstances->remove(curl);
HXLINE( 456)				status = ( (int)(curl->getInfo((int)2097154)) );
HXLINE( 457)				instance->parent->__SetField(HX_("responseStatus",93,60,a4,78),status,hx::paccDynamic);
HXLINE( 459)				curl->cleanup();
HXLINE( 460)				curl = null();
HXLINE( 462)				if ((message->result == (int)0)) {
HXLINE( 464)					bool _hx_tmp1;
HXDLIN( 464)					bool _hx_tmp2;
HXDLIN( 464)					if ((status >= (int)200)) {
HXLINE( 464)						_hx_tmp2 = (status < (int)400);
            					}
            					else {
HXLINE( 464)						_hx_tmp2 = false;
            					}
HXDLIN( 464)					if (!(_hx_tmp2)) {
HXLINE( 464)						_hx_tmp1 = (status == (int)0);
            					}
            					else {
HXLINE( 464)						_hx_tmp1 = true;
            					}
HXDLIN( 464)					if (_hx_tmp1) {
HXLINE( 466)						if (!(instance->promise->get_isError())) {
HXLINE( 468)							instance->promise->complete(instance->bytes);
            						}
            					}
            					else {
HXLINE( 472)						if (hx::IsNotNull( instance->bytes )) {
HXLINE( 474)							 ::lime::app::Promise_haxe_io_Bytes instance1 = instance->promise;
HXDLIN( 474)							instance1->error(instance->bytes->getString((int)0,instance->bytes->length,null()));
            						}
            						else {
HXLINE( 478)							 ::lime::app::Promise_haxe_io_Bytes instance2 = instance->promise;
HXDLIN( 478)							instance2->error((HX_("Status ",8e,8c,bf,03) + status));
            						}
            					}
            				}
            				else {
HXLINE( 484)					 ::lime::app::Promise_haxe_io_Bytes instance3 = instance->promise;
HXDLIN( 484)					instance3->error(::lime::net::curl::CURL_obj::strerror(message->result));
            				}
HXLINE( 488)				if (hx::IsNotNull( instance->timeout )) {
HXLINE( 490)					instance->timeout->stop();
HXLINE( 491)					instance->timeout = null();
            				}
HXLINE( 495)				instance->bytes = null();
HXLINE( 496)				instance->promise = null();
            			}
HXLINE( 500)			message = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->infoRead();
            		}
            	}
...
void NativeHTTPRequest_obj::threadPool_doWork( ::Dynamic state){
            	HX_STACKFRAME(&_hx_pos_11449fe5de606ab4_507_threadPool_doWork)
HXLINE( 509)		 ::lime::_internal::backend::native::NativeHTTPRequest instance = ( ( ::lime::_internal::backend::native::NativeHTTPRequest)(state->__Field(HX_("instance",95,1f,e1,59),hx::paccDynamic)) );
HXLINE( 510)		::String path = ( (::String)(state->__Field(HX_("uri",6c,2b,59,00),hx::paccDynamic)) );
HXLINE( 512)		int index = path.indexOf(HX_("?",3f,00,00,00),null());
HXLINE( 514)		if ((index > (int)-1)) {
HXLINE( 516)			path = path.substring((int)0,index);
            		}
HXLINE( 521)		if (::StringTools_obj::startsWith(path,HX_("~/",f1,6d,00,00))) {
HXLINE( 523)			::String path1 = (::Sys_obj::getEnv(HX_("HOME",1f,92,d3,2f)) + HX_("/",2f,00,00,00));
HXDLIN( 523)			path = (path1 + path.substr((int)2,null()));
            		}
HXLINE( 528)		bool _hx_tmp;
HXDLIN( 528)		if (hx::IsNotNull( path )) {
HXLINE( 528)			_hx_tmp = !(::sys::FileSystem_obj::exists(path));
            		}
            		else {
HXLINE( 528)			_hx_tmp = true;
            		}
HXDLIN( 528)		if (_hx_tmp) {
HXLINE( 530)			 ::lime::app::Promise_haxe_io_Bytes instance1 = instance->promise;
HXDLIN( 530)			::lime::_internal::backend::native::NativeHTTPRequest_obj::threadPool->sendError( ::Dynamic(hx::Anon_obj::Create(3)
...
HXLINE( 534)			instance->bytes = ::lime::utils::_Bytes::Bytes_Impl__obj::fromFile(path);
HXLINE( 536)			if (hx::IsNotNull( instance->bytes )) {
HXLINE( 538)				::lime::_internal::backend::native::NativeHTTPRequest_obj::threadPool->sendProgress( ::Dynamic(hx::Anon_obj::Create(4)
...
HXLINE( 539)				::lime::_internal::backend::native::NativeHTTPRequest_obj::threadPool->sendComplete( ::Dynamic(hx::Anon_obj::Create(3)
...
HXLINE( 543)				 ::lime::app::Promise_haxe_io_Bytes instance2 = instance->promise;
HXDLIN( 543)				::lime::_internal::backend::native::NativeHTTPRequest_obj::threadPool->sendError( ::Dynamic(hx::Anon_obj::Create(3)
...
void NativeHTTPRequest_obj::threadPool_onComplete( ::Dynamic state){
            	HX_STACKFRAME(&_hx_pos_11449fe5de606ab4_552_threadPool_onComplete)
HXLINE( 554)		 ::lime::app::Promise_haxe_io_Bytes promise = ( ( ::lime::app::Promise_haxe_io_Bytes)(state->__Field(HX_("promise",9b,cd,e9,f7),hx::paccDynamic)) );
HXLINE( 555)		if (promise->get_isError()) {
HXLINE( 555)			return;
            		}
HXLINE( 556)		promise->complete(( ( ::haxe::io::Bytes)(state->__Field(HX_("result",dd,68,84,08),hx::paccDynamic)) ));
HXLINE( 558)		 ::Dynamic instance = state->__Field(HX_("instance",95,1f,e1,59),hx::paccDynamic);
HXLINE( 560)		if (hx::IsNotNull( instance->__Field(HX_("timeout",a1,1a,f7,d8),hx::paccDynamic) )) {
HXLINE( 562)			 ::Dynamic(instance->__Field(HX_("timeout",a1,1a,f7,d8),hx::paccDynamic))->__Field(HX_("stop",02,f0,5b,4c),hx::paccDynamic)();
HXLINE( 563)			instance->__SetField(HX_("timeout",a1,1a,f7,d8),null(),hx::paccDynamic);
            		}
HXLINE( 567)		instance->__SetField(HX_("bytes",6b,08,98,bd),null(),hx::paccDynamic);
HXLINE( 568)		instance->__SetField(HX_("promise",9b,cd,e9,f7),null(),hx::paccDynamic);
            	}
...
void NativeHTTPRequest_obj::threadPool_onError( ::Dynamic state){
            	HX_STACKFRAME(&_hx_pos_11449fe5de606ab4_573_threadPool_onError)
HXLINE( 575)		 ::lime::app::Promise_haxe_io_Bytes promise = ( ( ::lime::app::Promise_haxe_io_Bytes)(state->__Field(HX_("promise",9b,cd,e9,f7),hx::paccDynamic)) );
HXLINE( 576)		promise->error( ::Dynamic(state->__Field(HX_("error",c8,cb,29,73),hx::paccDynamic)));
HXLINE( 578)		 ::Dynamic instance = state->__Field(HX_("instance",95,1f,e1,59),hx::paccDynamic);
HXLINE( 580)		if (hx::IsNotNull( instance->__Field(HX_("timeout",a1,1a,f7,d8),hx::paccDynamic) )) {
HXLINE( 582)			 ::Dynamic(instance->__Field(HX_("timeout",a1,1a,f7,d8),hx::paccDynamic))->__Field(HX_("stop",02,f0,5b,4c),hx::paccDynamic)();
HXLINE( 583)			instance->__SetField(HX_("timeout",a1,1a,f7,d8),null(),hx::paccDynamic);
            		}
HXLINE( 587)		instance->__SetField(HX_("bytes",6b,08,98,bd),null(),hx::paccDynamic);
HXLINE( 588)		instance->__SetField(HX_("promise",9b,cd,e9,f7),null(),hx::paccDynamic);
            	}
...
void NativeHTTPRequest_obj::threadPool_onProgress( ::Dynamic state){
            	HX_STACKFRAME(&_hx_pos_11449fe5de606ab4_593_threadPool_onProgress)
HXLINE( 595)		 ::lime::app::Promise_haxe_io_Bytes promise = ( ( ::lime::app::Promise_haxe_io_Bytes)(state->__Field(HX_("promise",9b,cd,e9,f7),hx::paccDynamic)) );
HXLINE( 596)		bool _hx_tmp;
HXDLIN( 596)		if (!(promise->get_isComplete())) {
HXLINE( 596)			_hx_tmp = promise->get_isError();
            		}
            		else {
...
HXLINE( 597)		promise->progress(( (int)(state->__Field(HX_("bytesLoaded",d0,66,ca,99),hx::paccDynamic)) ),( (int)(state->__Field(HX_("bytesTotal",59,57,da,45),hx::paccDynamic)) ));
            	}
