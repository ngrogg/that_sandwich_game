...
HX_DEFINE_STACK_FRAME(_hx_pos_281fad3e86f1efa8_688_new,"lime.utils._Assets.LibrarySymbol","new",0x85584603,"lime.utils._Assets.LibrarySymbol.new","lime/utils/Assets.hx",688,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_281fad3e86f1efa8_698_isLocal,"lime.utils._Assets.LibrarySymbol","isLocal",0x28a9f044,"lime.utils._Assets.LibrarySymbol.isLocal","lime/utils/Assets.hx",698,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_281fad3e86f1efa8_699_exists,"lime.utils._Assets.LibrarySymbol","exists",0xf7109019,"lime.utils._Assets.LibrarySymbol.exists","lime/utils/Assets.hx",699,0x95055f23)
namespace lime{
namespace utils{
namespace _Assets{

void LibrarySymbol_obj::__construct(::String id){
            	HX_STACKFRAME(&_hx_pos_281fad3e86f1efa8_688_new)
HXLINE( 690)		int colonIndex = id.indexOf(HX_(":",3a,00,00,00),null());
HXLINE( 691)		this->libraryName = id.substring((int)0,colonIndex);
HXLINE( 692)		this->symbolName = id.substring((colonIndex + (int)1),null());
HXLINE( 693)		this->library = ::lime::utils::Assets_obj::getLibrary(this->libraryName);
            	}
...
bool LibrarySymbol_obj::isLocal(::String type){
            	HX_STACKFRAME(&_hx_pos_281fad3e86f1efa8_698_isLocal)
HXDLIN( 698)		return this->library->isLocal(this->symbolName,type);
            	}
...
bool LibrarySymbol_obj::exists(::String type){
            	HX_STACKFRAME(&_hx_pos_281fad3e86f1efa8_699_exists)
HXDLIN( 699)		return this->library->exists(this->symbolName,type);
            	}
