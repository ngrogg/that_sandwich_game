...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("ThatSandwichGameFinal", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("ThatSandwichGameFinal", null, 640, 480);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["build"] = "775";
		app.meta["company"] = "Nicholas Grogg";
		app.meta["file"] = "ThatSandwichGameFinal";
		app.meta["name"] = "That Sandwich Game";
