...
class HXCPP_CLASS_ATTRIBUTES FlxVector_Impl__obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< FlxVector_Impl__obj > __new() {
			hx::ObjectPtr< FlxVector_Impl__obj > __this = new FlxVector_Impl__obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< FlxVector_Impl__obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("FlxVector_Impl_","\x15","\x5d","\x5e","\x0e"); }
