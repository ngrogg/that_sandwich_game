...
HXLINE(  45)			::ManifestResources_obj::rootPath = HX_("",00,00,00,00);
            		}
HXLINE(  50)		::lime::utils::Assets_obj::defaultRootPath = ::ManifestResources_obj::rootPath;
HXLINE(  53)		::openfl::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf >());
HXLINE(  54)		::openfl::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__OPENFL__flixel_fonts_monsterrat_ttf >());
HXLINE(  58)		 ::Dynamic data;
HXDLIN(  58)		 ::Dynamic manifest;
HXDLIN(  58)		 ::lime::utils::AssetLibrary library;
HXLINE(  71)		{
HXLINE(  71)			::String v = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  71)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v);
            		}
HXLINE(  74)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
HXLINE(  75)		if (hx::IsNotNull( library )) {
HXLINE(  75)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  76)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
