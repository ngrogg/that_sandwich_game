...
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_84_new,"openfl.display.Stage3D","new",0x52647737,"openfl.display.Stage3D.new","openfl/display/Stage3D.hx",84,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_106_requestContext3D,"openfl.display.Stage3D","requestContext3D",0x80c219da,"openfl.display.Stage3D.requestContext3D","openfl/display/Stage3D.hx",106,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_132_requestContext3DMatchingProfiles,"openfl.display.Stage3D","requestContext3DMatchingProfiles",0x5b5ae301,"openfl.display.Stage3D.requestContext3DMatchingProfiles","openfl/display/Stage3D.hx",132,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_137___createContext,"openfl.display.Stage3D","__createContext",0x1987b48a,"openfl.display.Stage3D.__createContext","openfl/display/Stage3D.hx",137,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_227___dispatchError,"openfl.display.Stage3D","__dispatchError",0xdb9710e5,"openfl.display.Stage3D.__dispatchError","openfl/display/Stage3D.hx",227,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_237___dispatchCreate,"openfl.display.Stage3D","__dispatchCreate",0x733e9b3f,"openfl.display.Stage3D.__dispatchCreate","openfl/display/Stage3D.hx",237,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_247___lostContext,"openfl.display.Stage3D","__lostContext",0x951652e2,"openfl.display.Stage3D.__lostContext","openfl/display/Stage3D.hx",247,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_263___resize,"openfl.display.Stage3D","__resize",0x193af2dd,"openfl.display.Stage3D.__resize","openfl/display/Stage3D.hx",263,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_293___restoreContext,"openfl.display.Stage3D","__restoreContext",0xa732262a,"openfl.display.Stage3D.__restoreContext","openfl/display/Stage3D.hx",293,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_303_get_x,"openfl.display.Stage3D","get_x",0x0609efe6,"openfl.display.Stage3D.get_x","openfl/display/Stage3D.hx",303,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_308_set_x,"openfl.display.Stage3D","set_x",0xeed8e5f2,"openfl.display.Stage3D.set_x","openfl/display/Stage3D.hx",308,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_322_get_y,"openfl.display.Stage3D","get_y",0x0609efe7,"openfl.display.Stage3D.get_y","openfl/display/Stage3D.hx",322,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_327_set_y,"openfl.display.Stage3D","set_y",0xeed8e5f3,"openfl.display.Stage3D.set_y","openfl/display/Stage3D.hx",327,0x37141b9b)
namespace openfl{
namespace display{

void Stage3D_obj::__construct( ::openfl::display::Stage stage){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_84_new)
HXLINE(  86)		super::__construct(null());
HXLINE(  88)		this->_hx___stage = stage;
HXLINE(  90)		this->_hx___height = (int)0;
HXLINE(  91)		this->_hx___projectionTransform =  ::openfl::geom::Matrix3D_obj::__alloc( HX_CTX ,null());
HXLINE(  92)		this->_hx___renderTransform =  ::openfl::geom::Matrix3D_obj::__alloc( HX_CTX ,null());
HXLINE(  93)		this->_hx___width = (int)0;
HXLINE(  94)		this->_hx___x = (int)0;
HXLINE(  95)		this->_hx___y = (int)0;
HXLINE(  97)		this->visible = true;
HXLINE(  99)		bool _hx_tmp;
HXDLIN(  99)		if ((stage->stageWidth > (int)0)) {
HXLINE(  99)			_hx_tmp = (stage->stageHeight > (int)0);
            		}
            		else {
HXLINE(  99)			_hx_tmp = false;
            		}
HXDLIN(  99)		if (_hx_tmp) {
HXLINE( 100)			this->_hx___resize(stage->stageWidth,stage->stageHeight);
            		}
            	}
...
void Stage3D_obj::requestContext3D( ::Dynamic __o_context3DRenderMode, ::Dynamic __o_profile){
 ...
 ::Dynamic profile = __o_profile.Default(0);
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_106_requestContext3D)
HXLINE( 108)		if (this->_hx___contextLost) {
HXLINE( 110)			this->_hx___contextRequested = true;
HXLINE( 111)			return;
            		}
HXLINE( 115)		if (hx::IsNotNull( this->context3D )) {
HXLINE( 117)			this->_hx___contextRequested = true;
HXLINE( 118)			::haxe::Timer_obj::delay(this->_hx___dispatchCreate_dyn(),(int)1);
            		}
            		else {
HXLINE( 120)			if (!(this->_hx___contextRequested)) {
HXLINE( 122)				this->_hx___contextRequested = true;
HXLINE( 123)				::haxe::Timer_obj::delay(this->_hx___createContext_dyn(),(int)1);
            			}
            		}
            	}
...
void Stage3D_obj::requestContext3DMatchingProfiles( ::openfl::_Vector::ObjectVector profiles){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_132_requestContext3DMatchingProfiles)
HXDLIN( 132)		this->requestContext3D(null(),null());
            	}
...
void Stage3D_obj::_hx___createContext(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_137___createContext)
HXLINE( 140)		 ::openfl::display::Stage stage = this->_hx___stage;
HXLINE( 141)		 ::openfl::display::DisplayObjectRenderer renderer = stage->_hx___renderer;
HXLINE( 143)		bool _hx_tmp;
HXDLIN( 143)		if ((renderer->_hx___type != HX_("cairo",88,30,19,41))) {
HXLINE( 143)			_hx_tmp = (renderer->_hx___type == HX_("canvas",d8,54,42,b8));
            		}
            		else {
HXLINE( 143)			_hx_tmp = true;
            		}
HXDLIN( 143)		if (_hx_tmp) {
HXLINE( 145)			this->_hx___dispatchError();
HXLINE( 146)			return;
            		}
HXLINE( 150)		if ((renderer->_hx___type == HX_("opengl",6f,64,94,21))) {
HXLINE( 155)			this->context3D =  ::openfl::display3D::Context3D_obj::__alloc( HX_CTX ,stage,stage->context3D->_hx___contextState,hx::ObjectPtr<OBJ_>(this));
HXLINE( 157)			this->_hx___dispatchCreate();
            		}
            		else {
HXLINE( 159)			bool _hx_tmp1 = (renderer->_hx___type == HX_("dom",82,42,4c,00));
            		}
            	}
...
void Stage3D_obj::_hx___dispatchError(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_227___dispatchError)
HXLINE( 229)		this->_hx___contextRequested = false;
HXLINE( 230)		this->dispatchEvent( ::openfl::events::ErrorEvent_obj::__alloc( HX_CTX ,HX_("error",c8,cb,29,73),false,false,HX_("Context3D not available",9c,fc,63,d3),null()));
            	}
...
void Stage3D_obj::_hx___dispatchCreate(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_237___dispatchCreate)
HXDLIN( 237)		if (this->_hx___contextRequested) {
HXLINE( 239)			this->_hx___contextRequested = false;
HXLINE( 240)			this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("context3DCreate",7c,bf,59,7b),null(),null()));
            		}
            	}
...
void Stage3D_obj::_hx___lostContext(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_247___lostContext)
HXLINE( 249)		this->_hx___contextLost = true;
HXLINE( 251)		if (hx::IsNotNull( this->context3D )) {
HXLINE( 253)			this->context3D->_hx___dispose();
HXLINE( 254)			this->_hx___contextRequested = true;
            		}
            	}
...
void Stage3D_obj::_hx___resize(int width,int height){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_263___resize)
HXDLIN( 263)		bool _hx_tmp;
HXDLIN( 263)		if ((width == this->_hx___width)) {
HXDLIN( 263)			_hx_tmp = (height != this->_hx___height);
            		}
            		else {
HXDLIN( 263)			_hx_tmp = true;
            		}
HXDLIN( 263)		if (_hx_tmp) {
HXLINE( 274)			 ::openfl::geom::Matrix3D _hx_tmp1 = this->_hx___projectionTransform;
HXDLIN( 274)			int length = null();
HXDLIN( 274)			bool fixed = null();
HXLINE( 275)			int _hx_tmp2;
HXDLIN( 275)			if ((width > (int)0)) {
HXLINE( 275)				_hx_tmp2 = width;
            			}
            			else {
HXLINE( 275)				_hx_tmp2 = (int)1;
            			}
HXLINE( 276)			int _hx_tmp3;
HXDLIN( 276)			if ((height > (int)0)) {
HXLINE( 276)				_hx_tmp3 = height;
            			}
            			else {
HXLINE( 276)				_hx_tmp3 = (int)1;
            			}
HXLINE( 274)			_hx_tmp1->copyRawDataFrom( ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,::Array_obj< Float >::__new(16)->init(0,((Float)((Float)2.0) / (Float)_hx_tmp2))->init(1,((Float)0.0))->init(2,((Float)0.0))->init(3,((Float)0.0))->init(4,((Float)0.0))->init(5,((Float)((Float)-2.0) / (Float)_hx_tmp3))->init(6,((Float)0.0))->init(7,((Float)0.0))->init(8,((Float)0.0))->init(9,((Float)0.0))->init(10,((Float)-0.001))->init(11,((Float)0.0))->init(12,((Float)-1.0))->init(13,((Float)1.0))->init(14,((Float)0.0))->init(15,((Float)1.0)),true),null(),null());
HXLINE( 281)			this->_hx___renderTransform->identity();
HXLINE( 282)			this->_hx___renderTransform->appendTranslation(this->_hx___x,this->_hx___y,(int)0);
HXLINE( 283)			this->_hx___renderTransform->append(this->_hx___projectionTransform);
HXLINE( 285)			this->_hx___width = width;
HXLINE( 286)			this->_hx___height = height;
            		}
            	}
...
void Stage3D_obj::_hx___restoreContext(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_293___restoreContext)
HXLINE( 295)		this->_hx___contextLost = false;
HXLINE( 296)		this->_hx___createContext();
            	}
...
Float Stage3D_obj::get_x(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_303_get_x)
HXDLIN( 303)		return this->_hx___x;
            	}
...
Float Stage3D_obj::set_x(Float value){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_308_set_x)
HXLINE( 310)		if ((this->_hx___x == value)) {
HXLINE( 310)			return value;
            		}
HXLINE( 311)		this->_hx___x = value;
HXLINE( 312)		this->_hx___renderTransform->identity();
HXLINE( 313)		this->_hx___renderTransform->appendTranslation(this->_hx___x,this->_hx___y,(int)0);
HXLINE( 314)		this->_hx___renderTransform->append(this->_hx___projectionTransform);
...
Float Stage3D_obj::get_y(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_322_get_y)
HXDLIN( 322)		return this->_hx___y;
            	}
...
Float Stage3D_obj::set_y(Float value){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_327_set_y)
HXLINE( 329)		if ((this->_hx___y == value)) {
HXLINE( 329)			return value;
            		}
HXLINE( 330)		this->_hx___y = value;
HXLINE( 331)		this->_hx___renderTransform->identity();
HXLINE( 332)		this->_hx___renderTransform->appendTranslation(this->_hx___x,this->_hx___y,(int)0);
HXLINE( 333)		this->_hx___renderTransform->append(this->_hx___projectionTransform);
