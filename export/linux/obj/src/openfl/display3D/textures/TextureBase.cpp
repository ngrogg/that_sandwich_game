...
HXLINE( 312)			if ((this->_hx___textureTarget == this->_hx___context->gl->TEXTURE_CUBE_MAP)) {
HXLINE( 313)				this->_hx___context->_hx___bindGLTextureCubeMap(this->_hx___textureID);
            			}
            			else {
HXLINE( 315)				this->_hx___context->_hx___bindGLTexture2D(this->_hx___textureID);
            			}
HXLINE( 317)			int wrapModeS = (int)0;
HXDLIN( 317)			int wrapModeT = (int)0;
HXLINE( 319)			{
HXLINE( 319)				 ::Dynamic _g = state->wrap;
HXDLIN( 319)				 ::Dynamic _hx_switch_0 = _g;
            				if (  (_hx_switch_0==(int)0) ){
HXLINE( 321)					wrapModeS = gl->CLAMP_TO_EDGE;
HXLINE( 322)					wrapModeT = gl->CLAMP_TO_EDGE;
HXLINE( 320)					goto _hx_goto_5;
            				}
            				if (  (_hx_switch_0==(int)1) ){
HXLINE( 324)					wrapModeS = gl->CLAMP_TO_EDGE;
HXLINE( 325)					wrapModeT = gl->REPEAT;
HXLINE( 323)					goto _hx_goto_5;
            				}
            				if (  (_hx_switch_0==(int)2) ){
HXLINE( 327)					wrapModeS = gl->REPEAT;
HXLINE( 328)					wrapModeT = gl->REPEAT;
HXLINE( 326)					goto _hx_goto_5;
            				}
            				if (  (_hx_switch_0==(int)3) ){
HXLINE( 330)					wrapModeS = gl->REPEAT;
HXLINE( 331)					wrapModeT = gl->CLAMP_TO_EDGE;
HXLINE( 329)					goto _hx_goto_5;
            				}
            				/* default */{
HXLINE( 333)					HX_STACK_DO_THROW( ::openfl::errors::Error_obj::__alloc( HX_CTX ,HX_("wrap bad enum",52,1c,4c,59),null()));
            				}
            				_hx_goto_5:;
            			}
HXLINE( 336)			int magFilter = (int)0;
HXDLIN( 336)			int minFilter = (int)0;
HXLINE( 338)			{
HXLINE( 338)				 ::Dynamic _g1 = state->filter;
HXDLIN( 338)				if (hx::IsEq( _g1,(int)5 )) {
HXLINE( 340)					magFilter = gl->NEAREST;
            				}
            				else {
HXLINE( 342)					magFilter = gl->LINEAR;
            				}
            			}
HXLINE( 345)			{
HXLINE( 345)				 ::Dynamic _g2 = state->mipfilter;
HXDLIN( 345)				 ::Dynamic _hx_switch_1 = _g2;
            				if (  (_hx_switch_1==(int)0) ){
HXLINE( 347)					if (hx::IsEq( state->filter,(int)5 )) {
HXLINE( 347)						minFilter = gl->NEAREST_MIPMAP_LINEAR;
            					}
            					else {
HXLINE( 347)						minFilter = gl->LINEAR_MIPMAP_LINEAR;
            					}
HXDLIN( 347)					goto _hx_goto_6;
            				}
            				if (  (_hx_switch_1==(int)1) ){
HXLINE( 349)					if (hx::IsEq( state->filter,(int)5 )) {
HXLINE( 349)						minFilter = gl->NEAREST_MIPMAP_NEAREST;
            					}
            					else {
HXLINE( 349)						minFilter = gl->LINEAR_MIPMAP_NEAREST;
            					}
HXDLIN( 349)					goto _hx_goto_6;
            				}
            				if (  (_hx_switch_1==(int)2) ){
HXLINE( 351)					if (hx::IsEq( state->filter,(int)5 )) {
HXLINE( 351)						minFilter = gl->NEAREST;
            					}
            					else {
HXLINE( 351)						minFilter = gl->LINEAR;
            					}
HXDLIN( 351)					goto _hx_goto_6;
            				}
            				/* default */{
HXLINE( 353)					HX_STACK_DO_THROW( ::openfl::errors::Error_obj::__alloc( HX_CTX ,HX_("mipfiter bad enum",b2,1b,09,c4),null()));
            				}
            				_hx_goto_6:;
            			}
HXLINE( 356)			gl->texParameteri(this->_hx___textureTarget,gl->TEXTURE_MIN_FILTER,minFilter);
HXLINE( 357)			gl->texParameteri(this->_hx___textureTarget,gl->TEXTURE_MAG_FILTER,magFilter);
HXLINE( 358)			gl->texParameteri(this->_hx___textureTarget,gl->TEXTURE_WRAP_S,wrapModeS);
HXLINE( 359)			gl->texParameteri(this->_hx___textureTarget,gl->TEXTURE_WRAP_T,wrapModeT);
HXLINE( 361)			bool _hx_tmp = (state->lodBias != ((Float)0.0));
HXLINE( 368)			if (hx::IsNull( this->_hx___samplerState )) {
HXLINE( 368)				this->_hx___samplerState = state->clone();
            			}
HXLINE( 369)			this->_hx___samplerState->copyFrom(state);
