...
HXLINE( 193)		 ::openfl::display3D::Program3D program = context3D->createProgram(null());
...
HXLINE( 644)							{
HXLINE( 644)								 ::openfl::utils::ByteArrayData this2 = this->agalcode;
HXDLIN( 644)								this2->writeByte(::Std_obj::_hx_int((bias * ((Float)8.0))));
            							}
HXLINE( 645)							this->agalcode->writeByte((int)0);
HXLINE( 646)							this->agalcode->writeUnsignedInt(samplerbits);
HXLINE( 648)							if (this->verbose) {
HXLINE( 650)								 ::Dynamic _hx_tmp30 = ::haxe::Log_obj::trace;
HXDLIN( 650)								_hx_tmp30((HX_("    bits: ",2c,b3,89,b1) + (samplerbits - (int)5)),hx::SourceInfo(HX_("AGALMiniAssembler.hx",46,16,79,50),650,HX_("openfl.utils.AGALMiniAssembler",1d,f7,bb,62),HX_("assemble",12,a9,1b,c5)));
            							}
...
HXLINE( 670)							{
HXLINE( 670)								int _hx_tmp31;
HXDLIN( 670)								if (isRelative) {
HXLINE( 670)									_hx_tmp31 = ((int)relsel | (int)(int)32768);
            								}
            								else {
HXLINE( 670)									_hx_tmp31 = (int)0;
            								}
HXDLIN( 670)								this->agalcode->writeShort(_hx_tmp31);
            							}
...
HXLINE( 701)			 ::openfl::utils::AGALMiniAssembler _hx_tmp32 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 701)			_hx_tmp32->error = (_hx_tmp32->error + (((HX_("\n  at line ",49,c3,70,34) + i) + HX_(" ",20,00,00,00)) + lines->__get(i)));
...
HXLINE( 745)			 ::Dynamic _hx_tmp33 = ::haxe::Log_obj::trace;
HXDLIN( 745)			::String _hx_tmp34 = ((HX_("AGALMiniAssembler.assemble time: ",4b,2c,a6,f9) + ((Float)(::openfl::Lib_obj::getTimer() - start) / (Float)(int)1000)) + HX_("s",73,00,00,00));
HXDLIN( 745)			_hx_tmp33(_hx_tmp34,hx::SourceInfo(HX_("AGALMiniAssembler.hx",46,16,79,50),745,HX_("openfl.utils.AGALMiniAssembler",1d,f7,bb,62),HX_("assemble",12,a9,1b,c5)));
            		}
