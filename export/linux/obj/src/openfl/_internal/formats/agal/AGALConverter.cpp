...
HXLINE(  96)			int a = agal->position;
HXDLIN(  96)			int b = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(agal);
HXDLIN(  96)			bool aNeg = (b < (int)0);
HXDLIN(  96)			bool bNeg = (a < (int)0);
HXDLIN(  96)			bool _hx_tmp;
HXDLIN(  96)			if ((aNeg != bNeg)) {
HXLINE(  96)				_hx_tmp = aNeg;
            			}
            			else {
HXLINE(  96)				_hx_tmp = (b > a);
            			}
...
HXLINE( 284)						_hx_tmp1 = hx::IsNotEq( existingUsage,::openfl::_internal::formats::agal::_AGALConverter::RegisterUsage_obj::VECTOR_4_ARRAY_dyn() );
            					}
            					else {
...
HXLINE( 318)						_hx_tmp2 = hx::IsNotEq( existingUsage1,::openfl::_internal::formats::agal::_AGALConverter::RegisterUsage_obj::VECTOR_4_ARRAY_dyn() );
            					}
            					else {
...
HXLINE( 356)						_hx_tmp3 = hx::IsNotEq( existingUsage2,::openfl::_internal::formats::agal::_AGALConverter::RegisterUsage_obj::VECTOR_4_ARRAY_dyn() );
            					}
            					else {
...
HXLINE( 497)				_hx_tmp4 = (version1.indexOf(HX_("WebGL",99,9f,e9,5a),null()) > (int)-1);
            			}
            			else {
HXLINE( 497)				_hx_tmp4 = true;
            			}
HXDLIN( 497)			::openfl::_internal::formats::agal::AGALConverter_obj::limitedProfile = _hx_tmp4;
            		}
