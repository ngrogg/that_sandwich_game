...
HXLINE(  74)			_hx_tmp1 = this->hasColorOffsets;
            		}
            		else {
...
HXLINE(  97)						this->colorMultipliers->push((int)1);
HXLINE(  98)						this->colorMultipliers->push((int)1);
HXLINE(  99)						this->colorMultipliers->push((int)1);
HXLINE( 101)						this->colorOffsets->push((int)0);
HXLINE( 102)						this->colorOffsets->push((int)0);
HXLINE( 103)						this->colorOffsets->push((int)0);
HXLINE( 104)						this->colorOffsets->push((int)0);
            					}
HXLINE( 107)					this->colorMultipliers->push((int)1);
            				}
            			}
            		}
            	}
...
HXLINE( 115)		if ((this->rects->get_length() == (int)0)) {
HXLINE( 116)			return;
            		}
...
HXLINE( 120)			_hx_tmp = (int)4;
            		}
            		else {
HXLINE( 120)			_hx_tmp = (int)5;
            		}
...
HXDLIN( 129)			parameter->value[(int)0] = true;
            		}
HXLINE( 130)		{
...
HXDLIN( 130)			parameter1->value[(int)0] = value;
            		}
...
HXLINE( 144)		parameter->value[(int)0] = value;
            	}
