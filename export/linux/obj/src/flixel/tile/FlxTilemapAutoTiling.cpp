...
static void FlxTilemapAutoTiling_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(FlxTilemapAutoTiling_obj::FULL,"FULL");
...
static void FlxTilemapAutoTiling_obj_sVisitStatic(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(FlxTilemapAutoTiling_obj::FULL,"FULL");
...
FULL = hx::CreateEnum< FlxTilemapAutoTiling_obj >(HX_HCSTRING("FULL","\x8f","\xb1","\x85","\x2e"),3,0);
