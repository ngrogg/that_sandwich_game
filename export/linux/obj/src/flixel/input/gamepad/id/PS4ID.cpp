...
HX_LOCAL_STACK_FRAME(_hx_pos_ad6715070e6121e4_52_boot,"flixel.input.gamepad.id.PS4ID","boot",0xf48071a4,"flixel.input.gamepad.id.PS4ID.boot","flixel/input/gamepad/id/PS4ID.hx",52,0x2ce48920)
HX_LOCAL_STACK_FRAME(_hx_pos_ad6715070e6121e4_53_boot,"flixel.input.gamepad.id.PS4ID","boot",0xf48071a4,"flixel.input.gamepad.id.PS4ID.boot","flixel/input/gamepad/id/PS4ID.hx",53,0x2ce48920)
HX_LOCAL_STACK_FRAME(_hx_pos_ad6715070e6121e4_54_boot,"flixel.input.gamepad.id.PS4ID","boot",0xf48071a4,"flixel.input.gamepad.id.PS4ID.boot","flixel/input/gamepad/id/PS4ID.hx",54,0x2ce48920)
HX_LOCAL_STACK_FRAME(_hx_pos_ad6715070e6121e4_55_boot,"flixel.input.gamepad.id.PS4ID","boot",0xf48071a4,"flixel.input.gamepad.id.PS4ID.boot","flixel/input/gamepad/id/PS4ID.hx",55,0x2ce48920)
HX_LOCAL_STACK_FRAME(_hx_pos_ad6715070e6121e4_56_boot,"flixel.input.gamepad.id.PS4ID","boot",0xf48071a4,"flixel.input.gamepad.id.PS4ID.boot","flixel/input/gamepad/id/PS4ID.hx",56,0x2ce48920)
HX_LOCAL_STACK_FRAME(_hx_pos_ad6715070e6121e4_57_boot,"flixel.input.gamepad.id.PS4ID","boot",0xf48071a4,"flixel.input.gamepad.id.PS4ID.boot","flixel/input/gamepad/id/PS4ID.hx",57,0x2ce48920)
...
HX_LOCAL_STACK_FRAME(_hx_pos_ad6715070e6121e4_71_boot,"flixel.input.gamepad.id.PS4ID","boot",0xf48071a4,"flixel.input.gamepad.id.PS4ID.boot","flixel/input/gamepad/id/PS4ID.hx",71,0x2ce48920)
HX_LOCAL_STACK_FRAME(_hx_pos_ad6715070e6121e4_73_boot,"flixel.input.gamepad.id.PS4ID","boot",0xf48071a4,"flixel.input.gamepad.id.PS4ID.boot","flixel/input/gamepad/id/PS4ID.hx",73,0x2ce48920)
HX_LOCAL_STACK_FRAME(_hx_pos_ad6715070e6121e4_74_boot,"flixel.input.gamepad.id.PS4ID","boot",0xf48071a4,"flixel.input.gamepad.id.PS4ID.boot","flixel/input/gamepad/id/PS4ID.hx",74,0x2ce48920)
HX_LOCAL_STACK_FRAME(_hx_pos_ad6715070e6121e4_76_boot,"flixel.input.gamepad.id.PS4ID","boot",0xf48071a4,"flixel.input.gamepad.id.PS4ID.boot","flixel/input/gamepad/id/PS4ID.hx",76,0x2ce48920)
HX_LOCAL_STACK_FRAME(_hx_pos_ad6715070e6121e4_79_boot,"flixel.input.gamepad.id.PS4ID","boot",0xf48071a4,"flixel.input.gamepad.id.PS4ID.boot","flixel/input/gamepad/id/PS4ID.hx",79,0x2ce48920)
HX_LOCAL_STACK_FRAME(_hx_pos_ad6715070e6121e4_80_boot,"flixel.input.gamepad.id.PS4ID","boot",0xf48071a4,"flixel.input.gamepad.id.PS4ID.boot","flixel/input/gamepad/id/PS4ID.hx",80,0x2ce48920)
HX_LOCAL_STACK_FRAME(_hx_pos_ad6715070e6121e4_82_boot,"flixel.input.gamepad.id.PS4ID","boot",0xf48071a4,"flixel.input.gamepad.id.PS4ID.boot","flixel/input/gamepad/id/PS4ID.hx",82,0x2ce48920)
...
HXDLIN(  59)		RIGHT_STICK_CLICK = (int)14;
            	}
{
...
{
            	HX_STACKFRAME(&_hx_pos_ad6715070e6121e4_71_boot)
HXDLIN(  71)		SHARE = (int)10;
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_ad6715070e6121e4_73_boot)
HXDLIN(  73)		LEFT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__alloc( HX_CTX ,(int)0,(int)1, ::Dynamic(hx::Anon_obj::Create(4)
...
{
            	HX_GC_STACKFRAME(&_hx_pos_ad6715070e6121e4_74_boot)
HXDLIN(  74)		RIGHT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__alloc( HX_CTX ,(int)2,(int)3, ::Dynamic(hx::Anon_obj::Create(4)
...
{
            	HX_STACKFRAME(&_hx_pos_ad6715070e6121e4_76_boot)
HXDLIN(  76)		TOUCHPAD_CLICK = (int)30;
            	}
{
            	HX_STACKFRAME(&_hx_pos_ad6715070e6121e4_79_boot)
HXDLIN(  79)		L2 = (int)4;
            	}
{
            	HX_STACKFRAME(&_hx_pos_ad6715070e6121e4_80_boot)
HXDLIN(  80)		R2 = (int)5;
            	}
{
            	HX_STACKFRAME(&_hx_pos_ad6715070e6121e4_82_boot)
HXDLIN(  82)		DPAD_UP = (int)17;
            	}
{
            	HX_STACKFRAME(&_hx_pos_ad6715070e6121e4_83_boot)
HXDLIN(  83)		DPAD_DOWN = (int)18;
            	}
{
            	HX_STACKFRAME(&_hx_pos_ad6715070e6121e4_84_boot)
HXDLIN(  84)		DPAD_LEFT = (int)19;
            	}
{
            	HX_STACKFRAME(&_hx_pos_ad6715070e6121e4_85_boot)
HXDLIN(  85)		DPAD_RIGHT = (int)20;
            	}
}
