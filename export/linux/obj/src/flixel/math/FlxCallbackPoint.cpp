...
HX_DEFINE_STACK_FRAME(_hx_pos_0e989bab684323cb_509_new,"flixel.math.FlxCallbackPoint","new",0x2af621df,"flixel.math.FlxCallbackPoint.new","flixel/math/FlxPoint.hx",509,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_0e989bab684323cb_526_set,"flixel.math.FlxCallbackPoint","set",0x2af9ed21,"flixel.math.FlxCallbackPoint.set","flixel/math/FlxPoint.hx",526,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_0e989bab684323cb_534_set_x,"flixel.math.FlxCallbackPoint","set_x",0x4f288a9a,"flixel.math.FlxCallbackPoint.set_x","flixel/math/FlxPoint.hx",534,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_0e989bab684323cb_542_set_y,"flixel.math.FlxCallbackPoint","set_y",0x4f288a9b,"flixel.math.FlxCallbackPoint.set_y","flixel/math/FlxPoint.hx",542,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_0e989bab684323cb_550_destroy,"flixel.math.FlxCallbackPoint","destroy",0xdd08a9f9,"flixel.math.FlxCallbackPoint.destroy","flixel/math/FlxPoint.hx",550,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_0e989bab684323cb_557_put,"flixel.math.FlxCallbackPoint","put",0x2af7b44e,"flixel.math.FlxCallbackPoint.put","flixel/math/FlxPoint.hx",557,0xb3e1cd2c)
namespace flixel{
namespace math{

void FlxCallbackPoint_obj::__construct( ::Dynamic setXCallback, ::Dynamic setYCallback, ::Dynamic setXYCallback){
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_509_new)
HXLINE( 510)		super::__construct(null(),null());
HXLINE( 512)		this->_setXCallback = setXCallback;
HXLINE( 513)		this->_setYCallback = setXYCallback;
HXLINE( 514)		this->_setXYCallback = setXYCallback;
HXLINE( 516)		if (hx::IsNotNull( this->_setXCallback )) {
HXLINE( 518)			if (hx::IsNull( this->_setYCallback )) {
HXLINE( 519)				this->_setYCallback = setXCallback;
            			}
HXLINE( 520)			if (hx::IsNull( this->_setXYCallback )) {
HXLINE( 521)				this->_setXYCallback = setXCallback;
            			}
            		}
            	}
...
Float Y = __o_Y.Default(0);
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_526_set)
HXLINE( 527)		this->super::set(X,Y);
HXLINE( 528)		if (hx::IsNotNull( this->_setXYCallback )) {
HXLINE( 529)			this->_setXYCallback(hx::ObjectPtr<OBJ_>(this));
            		}
...
Float FlxCallbackPoint_obj::set_x(Float Value){
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_534_set_x)
HXLINE( 535)		this->super::set_x(Value);
HXLINE( 536)		if (hx::IsNotNull( this->_setXCallback )) {
HXLINE( 537)			this->_setXCallback(hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE( 538)		return Value;
            	}


Float FlxCallbackPoint_obj::set_y(Float Value){
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_542_set_y)
HXLINE( 543)		this->super::set_y(Value);
HXLINE( 544)		if (hx::IsNotNull( this->_setYCallback )) {
HXLINE( 545)			this->_setYCallback(hx::ObjectPtr<OBJ_>(this));
            		}
...
void FlxCallbackPoint_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_550_destroy)
HXLINE( 551)		this->super::destroy();
HXLINE( 552)		this->_setXCallback = null();
HXLINE( 553)		this->_setYCallback = null();
HXLINE( 554)		this->_setXYCallback = null();
            	}


void FlxCallbackPoint_obj::put(){
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_557_put)
            	}
