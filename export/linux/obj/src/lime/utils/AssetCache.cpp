...
HX_DEFINE_STACK_FRAME(_hx_pos_77dd7e775494cb08_18_new,"lime.utils.AssetCache","new",0x205507da,"lime.utils.AssetCache.new","lime/utils/AssetCache.hx",18,0xcfac28d4)
HX_LOCAL_STACK_FRAME(_hx_pos_77dd7e775494cb08_45_exists,"lime.utils.AssetCache","exists",0x81df4ea2,"lime.utils.AssetCache.exists","lime/utils/AssetCache.hx",45,0xcfac28d4)
HX_LOCAL_STACK_FRAME(_hx_pos_77dd7e775494cb08_72_set,"lime.utils.AssetCache","set",0x2058d31c,"lime.utils.AssetCache.set","lime/utils/AssetCache.hx",72,0xcfac28d4)
HX_LOCAL_STACK_FRAME(_hx_pos_77dd7e775494cb08_99_clear,"lime.utils.AssetCache","clear",0x54b4fb87,"lime.utils.AssetCache.clear","lime/utils/AssetCache.hx",99,0xcfac28d4)
namespace lime{
namespace utils{

void AssetCache_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_77dd7e775494cb08_18_new)
HXLINE(  22)		this->enabled = true;
HXLINE(  30)		this->audio =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE(  31)		this->font =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE(  32)		this->image =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE(  39)		this->version = (int)693898;
            	}
...
bool AssetCache_obj::exists(::String id,::String type){
            	HX_STACKFRAME(&_hx_pos_77dd7e775494cb08_45_exists)
HXLINE(  47)		bool _hx_tmp;
HXDLIN(  47)		if ((type != HX_("IMAGE",3b,57,57,3b))) {
HXLINE(  47)			_hx_tmp = hx::IsNull( type );
            		}
            		else {
HXLINE(  47)			_hx_tmp = true;
            		}
HXDLIN(  47)		if (_hx_tmp) {
HXLINE(  49)			if (this->image->exists(id)) {
HXLINE(  49)				return true;
            			}
            		}
HXLINE(  53)		bool _hx_tmp1;
HXDLIN(  53)		if ((type != HX_("FONT",cf,25,81,2e))) {
HXLINE(  53)			_hx_tmp1 = hx::IsNull( type );
            		}
            		else {
HXLINE(  53)			_hx_tmp1 = true;
            		}
HXDLIN(  53)		if (_hx_tmp1) {
HXLINE(  55)			if (this->font->exists(id)) {
HXLINE(  55)				return true;
            			}
            		}
HXLINE(  59)		bool _hx_tmp2;
HXDLIN(  59)		bool _hx_tmp3;
HXDLIN(  59)		if ((type != HX_("SOUND",af,c4,ba,fe))) {
HXLINE(  59)			_hx_tmp3 = (type == HX_("MUSIC",85,08,49,8e));
            		}
            		else {
HXLINE(  59)			_hx_tmp3 = true;
            		}
HXDLIN(  59)		if (!(_hx_tmp3)) {
HXLINE(  59)			_hx_tmp2 = hx::IsNull( type );
            		}
            		else {
HXLINE(  59)			_hx_tmp2 = true;
            		}
HXDLIN(  59)		if (_hx_tmp2) {
HXLINE(  61)			if (this->audio->exists(id)) {
...
void AssetCache_obj::set(::String id,::String type, ::Dynamic asset){
            	HX_STACKFRAME(&_hx_pos_77dd7e775494cb08_72_set)
HXDLIN(  72)		::String _hx_switch_0 = type;
            		if (  (_hx_switch_0==HX_("FONT",cf,25,81,2e)) ){
HXLINE(  75)			::haxe::IMap_obj::set(this->font,id,asset);
HXDLIN(  75)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==HX_("IMAGE",3b,57,57,3b)) ){
HXLINE(  78)			if (!(::Std_obj::is(asset,hx::ClassOf< ::lime::graphics::Image >()))) {
HXLINE(  79)				HX_STACK_DO_THROW(((HX_("Cannot cache non-Image asset: ",d6,62,c2,3a) + ::Std_obj::string(asset)) + HX_(" as Image",ad,d1,70,d4)));
            			}
HXLINE(  81)			::haxe::IMap_obj::set(this->image,id,( ( ::lime::graphics::Image)(asset) ));
HXLINE(  77)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==HX_("MUSIC",85,08,49,8e)) ||  (_hx_switch_0==HX_("SOUND",af,c4,ba,fe)) ){
HXLINE(  84)			if (!(::Std_obj::is(asset,hx::ClassOf< ::lime::media::AudioBuffer >()))) {
HXLINE(  85)				HX_STACK_DO_THROW(((HX_("Cannot cache non-AudioBuffer asset: ",b1,96,a5,01) + ::Std_obj::string(asset)) + HX_(" as AudioBuffer",48,2a,fe,73)));
            			}
HXLINE(  87)			::haxe::IMap_obj::set(this->audio,id,( ( ::lime::media::AudioBuffer)(asset) ));
HXLINE(  83)			goto _hx_goto_2;
            		}
            		/* default */{
HXLINE(  90)			HX_STACK_DO_THROW((type + HX_(" assets are not cachable",f3,2d,ee,fa)));
            		}
            		_hx_goto_2:;
            	}
...
void AssetCache_obj::clear(::String prefix){
            	HX_GC_STACKFRAME(&_hx_pos_77dd7e775494cb08_99_clear)
HXDLIN(  99)		if (hx::IsNull( prefix )) {
HXLINE( 101)			this->audio =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 102)			this->font =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 103)			this->image =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            		}
            		else {
HXLINE( 107)			 ::Dynamic keys = this->audio->keys();
HXLINE( 109)			{
HXLINE( 109)				 ::Dynamic key = keys;
HXDLIN( 109)				while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 109)					::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 111)					if (::StringTools_obj::startsWith(key1,prefix)) {
HXLINE( 113)						this->audio->remove(key1);
            					}
            				}
            			}
HXLINE( 119)			 ::Dynamic keys1 = this->font->keys();
HXLINE( 121)			{
HXLINE( 121)				 ::Dynamic key2 = keys1;
HXDLIN( 121)				while(( (bool)(key2->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 121)					::String key3 = ( (::String)(key2->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 123)					if (::StringTools_obj::startsWith(key3,prefix)) {
HXLINE( 125)						this->font->remove(key3);
            					}
            				}
            			}
HXLINE( 131)			 ::Dynamic keys2 = this->image->keys();
HXLINE( 133)			{
HXLINE( 133)				 ::Dynamic key4 = keys2;
HXDLIN( 133)				while(( (bool)(key4->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 133)					::String key5 = ( (::String)(key4->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 135)					if (::StringTools_obj::startsWith(key5,prefix)) {
HXLINE( 137)						this->image->remove(key5);
            					}
            				}
            			}
            		}
