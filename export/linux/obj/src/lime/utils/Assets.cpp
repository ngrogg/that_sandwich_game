...
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_526_loadLibrary,"lime.utils.Assets","loadLibrary",0x93baf7c0,"lime.utils.Assets.loadLibrary","lime/utils/Assets.hx",526,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_551_loadLibrary,"lime.utils.Assets","loadLibrary",0x93baf7c0,"lime.utils.Assets.loadLibrary","lime/utils/Assets.hx",551,0x95055f23)
...
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_564_loadText,"lime.utils.Assets","loadText",0xc4d2fec8,"lime.utils.Assets.loadText","lime/utils/Assets.hx",564,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_569_registerLibrary,"lime.utils.Assets","registerLibrary",0xb6301ea3,"lime.utils.Assets.registerLibrary","lime/utils/Assets.hx",569,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_596_unloadLibrary,"lime.utils.Assets","unloadLibrary",0xc816d6c7,"lime.utils.Assets.unloadLibrary","lime/utils/Assets.hx",596,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_630___cacheBreak,"lime.utils.Assets","__cacheBreak",0xe7faf592,"lime.utils.Assets.__cacheBreak","lime/utils/Assets.hx",630,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_635___libraryNotFound,"lime.utils.Assets","__libraryNotFound",0x7dfa37b5,"lime.utils.Assets.__libraryNotFound","lime/utils/Assets.hx",635,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_663_library_onChange,"lime.utils.Assets","library_onChange",0x3a89dec8,"lime.utils.Assets.library_onChange","lime/utils/Assets.hx",663,0x95055f23)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Assets_obj,loadImage,return )
 ...
 ::lime::app::Future Assets_obj::loadLibrary(::String id){
            		...
            		void _hx_run( ::lime::utils::AssetManifest manifest){
            			HX_GC_STACKFRAME(&_hx_pos_df5754140b017d9f_526_loadLibrary)
HXLINE( 528)			if (hx::IsNull( manifest )) {
HXLINE( 530)				promise->error(((HX_("Cannot parse asset manifest for library \"",cf,1e,cc,48) + id) + HX_("\"",22,00,00,00)));
HXLINE( 531)				return;
            			}
HXLINE( 535)			 ::lime::utils::AssetLibrary library1 = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
HXLINE( 537)			if (hx::IsNull( library1 )) {
HXLINE( 539)				promise->error(((HX_("Cannot open library \"",44,cc,55,e7) + id) + HX_("\"",22,00,00,00)));
            			}
            			else {
HXLINE( 543)				::lime::utils::Assets_obj::libraries->set(id,library1);
HXLINE( 544)				library1->onChange->add(::lime::utils::Assets_obj::onChange->dispatch_dyn(),null(),null());
HXLINE( 545)				 ::lime::app::Future _hx_tmp = library1->load();
HXDLIN( 545)				promise->completeWith(_hx_tmp);
            			}
            		}
            		HX_END_LOCAL_FUNC1((void))
            		...
            		void _hx_run( ::Dynamic _){
            			HX_GC_STACKFRAME(&_hx_pos_df5754140b017d9f_551_loadLibrary)
HXLINE( 551)			promise->error(((HX_("There is no asset library with an ID of \"",8b,06,e2,9a) + id) + HX_("\"",22,00,00,00)));
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE( 516)			if (::StringTools_obj::endsWith(path,HX_(".bundle",30,4a,b8,4e))) {
HXLINE( 518)				path = (path + HX_("/library.json",2a,a7,07,47));
            			}
HXLINE( 522)			path = ::lime::utils::Assets_obj::_hx___cacheBreak(path);
            		}
HXLINE( 526)		::lime::utils::AssetManifest_obj::loadFromFile(path,rootPath)->onComplete( ::Dynamic(new _hx_Closure_0(id,promise)))->onError( ::Dynamic(new _hx_Closure_1(id,promise)));
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Assets_obj,loadLibrary,return )
 ...
 ::lime::app::Future Assets_obj::loadText(::String id){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_564_loadText)
HXDLIN( 564)		return ::lime::utils::Assets_obj::loadAsset(id,HX_("TEXT",ad,94,ba,37),false);
            	}
...
void Assets_obj::registerLibrary(::String name, ::lime::utils::AssetLibrary library){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_569_registerLibrary)
HXLINE( 571)		if (::lime::utils::Assets_obj::libraries->exists(name)) {
HXLINE( 573)			if (hx::IsEq( ::lime::utils::Assets_obj::libraries->get(name).StaticCast<  ::lime::utils::AssetLibrary >(),library )) {
HXLINE( 575)				return;
            			}
            			else {
HXLINE( 579)				::lime::utils::Assets_obj::unloadLibrary(name);
            			}
            		}
HXLINE( 585)		if (hx::IsNotNull( library )) {
HXLINE( 587)			library->onChange->add(::lime::utils::Assets_obj::library_onChange_dyn(),null(),null());
            		}
HXLINE( 591)		::lime::utils::Assets_obj::libraries->set(name,library);
            	}
...
void Assets_obj::unloadLibrary(::String name){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_596_unloadLibrary)
HXLINE( 600)		 ::lime::utils::AssetLibrary library = ::lime::utils::Assets_obj::libraries->get(name).StaticCast<  ::lime::utils::AssetLibrary >();
HXLINE( 602)		if (hx::IsNotNull( library )) {
HXLINE( 604)			 ::lime::utils::AssetCache _hx_tmp = ::lime::utils::Assets_obj::cache;
HXDLIN( 604)			_hx_tmp->clear((name + HX_(":",3a,00,00,00)));
HXLINE( 605)			library->onChange->remove(::lime::utils::Assets_obj::library_onChange_dyn());
HXLINE( 606)			library->unload();
            		}
HXLINE( 610)		::lime::utils::Assets_obj::libraries->remove(name);
            	}
...
::String Assets_obj::_hx___cacheBreak(::String path){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_630___cacheBreak)
HXDLIN( 630)		return path;
            	}
...
::String Assets_obj::_hx___libraryNotFound(::String name){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_635___libraryNotFound)
HXLINE( 637)		bool _hx_tmp;
HXDLIN( 637)		if (hx::IsNotNull( name )) {
HXLINE( 637)			_hx_tmp = (name == HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 637)			_hx_tmp = true;
            		}
HXDLIN( 637)		if (_hx_tmp) {
HXLINE( 639)			name = HX_("default",c1,d8,c3,9b);
            		}
HXLINE( 643)		bool _hx_tmp1;
HXDLIN( 643)		bool _hx_tmp2;
HXDLIN( 643)		if (hx::IsNotNull( ::lime::app::Application_obj::current )) {
HXLINE( 643)			_hx_tmp2 = hx::IsNotNull( ::lime::app::Application_obj::current->_hx___preloader );
            		}
            		else {
HXLINE( 643)			_hx_tmp2 = false;
            		}
HXDLIN( 643)		if (_hx_tmp2) {
HXLINE( 643)			_hx_tmp1 = !(::lime::app::Application_obj::current->_hx___preloader->complete);
            		}
            		else {
HXLINE( 643)			_hx_tmp1 = false;
            		}
HXDLIN( 643)		if (_hx_tmp1) {
HXLINE( 645)			return ((HX_("There is no asset library named \"",a1,83,5f,51) + name) + HX_("\", or it is not yet preloaded",db,ac,d4,2f));
            		}
            		else {
HXLINE( 649)			return ((HX_("There is no asset library named \"",a1,83,5f,51) + name) + HX_("\"",22,00,00,00));
            		}
...
void Assets_obj::library_onChange(){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_663_library_onChange)
HXLINE( 665)		::lime::utils::Assets_obj::cache->clear(null());
HXLINE( 666)		::lime::utils::Assets_obj::onChange->dispatch();
            	}
